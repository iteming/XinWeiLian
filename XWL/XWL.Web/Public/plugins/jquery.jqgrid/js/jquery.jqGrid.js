...
! function (a) {
    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        msiever: function () {
            ...
            var js = jsonString;
            return "while(1);" === js.substr(0, 9) && (js = js.substr(9)), "/*" === js.substr(0, 2) && (js = js.substr(2, js.length - 4)), js || (js = "{}"), $.jgrid.useJSON === true && "object" == typeof JSON && "function" == typeof JSON.parse ? JSON.parse(js) : eval("(" + js + ")")
            ...
            else o = new Date(n.y, n.m, n.d, n.h, n.i, n.s, n.u); if (d.userLocalTime && 0 === q && (q -= (new Date).getTimezoneOffset(), q > 0 && o.setTime(Number(Number(o) + 60 * q * 1e3))), void 0 === c) return o;
        ...
        from: function (source) {
            var $t = this,
                QueryObject = function (d, q) {
                    ...
                    return d.length > 0 && (_useProperties = "object" != typeof d[0] ? false : true), this._hasData = function () {
                        return null === _data ? false : 0 === _data.length ? false : true
                        ...
                        _negate && (_query += "!"), _query += "(" + a + ")", _negate = false, _queuedOperator = "", _orDepth = 0
                        ...
                        return _usecase = false, self
                    }, this.useCase = function () {
                        return _usecase = true, self
                    }, this.trim = function () {
                        return _trim = true, self
                    }, this.noTrim = function () {
                        return _trim = false, self
                        ...
                        return self._hasData() ? (self.execute(), _data.length > 0) : false
                        ...
                        return b = null == b ? "a" : $.trim(b.toString().toLowerCase()), null == c && (c = "text"), null == d && (d = "Y-m-d"), null == e && (e = false), ("desc" === b || "descending" === b) && (b = "d"), ("asc" === b || "ascending" === b) && (b = "a"), _sorting.push({
                            by: a,
                            dir: b,
                            type: c,
                            datefmt: d,
            ...
            if (c.grid) {
                b = c.grid, $.isFunction(b.emptyRows) && b.emptyRows.call(c, true, true), $(document).unbind("mouseup.jqGrid" + c.p.id), $(b.hDiv).unbind("mousemove"), $(c).unbind();
            ...
            Bootstrap: {
                ...
                base: {
                    ...
                    icon_asc: "fa-triangle-top",
                    icon_desc: "fa-triangle-bottom",
                    icon_caption_open: "fa-circle-arrow-up",
                    icon_caption_close: "fa-circle-arrow-down"
                },
                modal: {
                    modal: "modal-content",
                    header: "modal-header",
                    ...
                    content: "modal-body",
                    resizable: "ui-resizable-handle ui-resizable-se",
                    icon_close: "fa-remove-circle",
                    icon_resizable: "fa-import"
                },
                celledit: {
                ...
                inlinedit: {
                    ...
                    icon_cancel_nav: "fa-remove-circle"
                },
                formedit: {
                    inputClass: "form-control",
                ...
                navigator: {
                    ...
                    icon_view_nav: "fa-info-sign",
                    icon_newbutton_nav: "fa-new-window"
                },
                grouping: {
                    icon_plus: "fa-triangle-right",
                    icon_minus: "fa-triangle-bottom"
                },
                filter: {
                ...
                subgrid: {
                    icon_plus: "fa-triangle-right",
                    icon_minus: "fa-triangle-bottom",
                    icon_open: "fa-indent-left"
                },
                treegrid: {
                    icon_plus: "fa-triangle-right",
                    icon_minus: "fa-triangle-bottom",
                    icon_leaf: "fa-unchecked"
                },
                fmatter: {
                    icon_edit: "fa-edit",
                    icon_add: "fa-plus",
        ...
        return this.each(function () {
            if (!this.grid) {
                    ...
                    e = {
                        ...
                        dragStart: function (a, b, e) {
                            ...
                            if (this.resizing) {
                                ...
                                }), c.forceFit === true ? (b = this.headers[this.resizing.idx + c.nv], d = "ltr" === c.direction ? b.width - e : b.width + e, d > c.minColWidth && (f.newWidth = g, b.newWidth = d)) : (this.newWidth = "ltr" === c.direction ? c.tblwidth + e : c.tblwidth - e, f.newWidth = g))
                            }
                        }, dragEnd: function (a) {
                            if (this.hDiv.style.cursor = "default", this.resizing) {
                                var b = this.resizing.idx,
                                    e = this.headers[b].newWidth || this.headers[b].width;
                                e = parseInt(e, 10), this.resizing = false, $("#rs_m" + $.jgrid.jqID(c.id)).css("display", "none"), c.colModel[b].width = e, this.headers[b].width = e, this.headers[b].el.style.width = e + "px", this.cols[b].style.width = e + "px", this.footers.length > 0 && (this.footers[b].style.width = e + "px"), c.forceFit === true ? (e = this.headers[b + c.nv].newWidth || this.headers[b + c.nv].width, this.headers[b + c.nv].width = e, this.headers[b + c.nv].el.style.width = e + "px", this.cols[b + c.nv].style.width = e + "px", this.footers.length > 0 && (this.footers[b + c.nv].style.width = e + "px"), c.colModel[b + c.nv].width = e) : (c.tblwidth = this.newWidth || c.tblwidth, $("table:first", this.bDiv).css("width", c.tblwidth + "px"), $("table:first", this.hDiv).css("width", c.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, c.footerrow && ($("table:first", this.sDiv).css("width", c.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft)), a && ($(d).triggerHandler("jqGridResizeStop", [e, b]), $.isFunction(c.resizeStop) && c.resizeStop.call(d, e, b))
                            }
                            ...
                            if (a) {
                                ...
                                if (f) {
                                    ...
                                    var i, j, k, l = c.rowNum,
                                        ...
                                        o = n + g.height(),
                                        p = f * l;
                                    if (a > o && 0 >= n && (void 0 === c.lastpage || (parseInt((o + m + p - 1) / p, 10) || 0) <= c.lastpage) && (j = parseInt((a - o + p - 1) / p, 10) || 1, o >= 0 || 2 > j || c.scroll === true ? (i = (Math.round((o + m) / p) || 0) + 1, n = -1) : n = 1), n > 0 && (i = (parseInt(m / p, 10) || 0) + 1, j = (parseInt((m + a) / p, 10) || 0) + 2 - i, k = true), j) {
                                        if (c.lastpage && (i > c.lastpage || 1 === c.lastpage || i === c.page && i === c.lastpage)) return;
                                        e.hDiv.loading ? e.timer = setTimeout(e.populateVisible, c.scrollTimeout) : (c.page = i, k && (e.selectionPreserver(g[0]), e.emptyRows.call(g[0], false, false)), e.populate(j)), c.scrollPopUp && null != c.lastpage && ($("#scroll_g" + c.id).show().html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", c.pgtext), c.page, c.lastpage)).css({
                            ...
                            var b = a.p,
                                ...
                                f = function () {
                                    ...
                                    if (b.selrow = null, b.selarrrow = [], b.multiselect && d && d.length > 0)
                                        for (g = 0; g < d.length; g++) d[g] !== c && $(a).jqGrid("setSelection", d[g], false, null);
                                    c && $(a).jqGrid("setSelection", c, false, null), a.grid.bDiv.scrollLeft = e, $(a).unbind(".selectionPreserver", f)
                                };
                ...
                var j, k = $.jgrid.getMethod("getStyleUI"),
                    ...
                    m = k(l, "disabled", true),
                    n = k(l, "highlight", true),
                    o = k(l, "hover", true),
                    p = k(l, "cornerall", true),
                    q = k(l, "icon_base", true),
                    r = $.jgrid.msie,
                    s = [],
                    t = [],
                    u = [];
                l = d.p.styleUI + ".base", j = $("<div " + k(l, "viewBox", false, "ui-jqgrid-view") + " role='grid'></div>"), d.p.direction = $.trim(d.p.direction.toLowerCase()), d.p._ald = false, -1 === $.inArray(d.p.direction, ["ltr", "rtl"]) && (d.p.direction = "ltr"), h = d.p.direction, $(j).insertBefore(this), $(this).appendTo(j);
                var v = $("<div " + k(l, "entrieBox", false, "ui-jqgrid") + "></div>");
                $(v).attr({
                    id: "gbox_" + this.id,
                    dir: h
                }).insertBefore(j), $(j).attr("id", "gview_" + this.id).appendTo(v), $("<div " + k(d.p.styleUI + ".common", "overlay", false, "jqgrid-overlay") + " id='lui_" + this.id + "'></div>").insertBefore(j), $("<div " + k(l, "loadingBox", false, "loading") + " id='load_" + this.id + "'>" + $.jgrid.getRegional(d, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(j), $(this).attr({
                    role: "presentation",
                ...
                var w, x = ["shiftKey", "altKey", "ctrlKey"],
                    ...
                    E = function (a, b, c, d, e) {
                        var f = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b,
                            g = z(a, b, f, null, b, true);
                        return '<td role="gridcell" ' + e + " " + g + ">" + f + "</td>"
                    },
                    F = function (a) {
                        var b, c, e = [],
                            f = 0;
                        for (c = 0; c < d.p.colModel.length; c++) b = d.p.colModel[c], "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name, d.p.keyName !== false && b.key === true && (d.p.keyName = e[f]), f++);
                        return e
                    },
                    G = function (a) {
                    ...
                    H = function (a, b) {
                        ...
                        this.p.deepempty ? $(this.rows).slice(1).remove() : (c = this.rows.length > 0 ? this.rows[0] : null, $(this.firstChild).empty().append(c)), a && this.p.scroll && ($(this.grid.bDiv.firstChild).css({
                            ...
                            height: "0px",
                            display: "none"
                        }), 0 !== this.grid.bDiv.scrollTop && (this.grid.bDiv.scrollTop = 0)), b === true && this.p.treeGrid && !this.p.loadonce && (this.p.data = [], this.p._index = {})
                    },
                    I = function () {
                        var a, b, c, e, f, g, h, i, j, k, l, m = d.p,
                            ...
                            q = m.colModel,
                            r = p.cell,
                            s = (m.multiselect === true ? 1 : 0) + (m.subGrid === true ? 1 : 0) + (m.rownumbers === true ? 1 : 0),
                            t = m.scroll ? $.jgrid.randId() : 1;
                        if ("local" === m.datatype && p.repeatitems === true)
                            for (j = G(s), k = F("local"), e = m.keyIndex === false ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
                    ...
                    J = function () {
                        ...
                        for (a = d.p.keyName === false || d.p.loadonce === true ? d.p.localReader.id : d.p.keyName, d.p._index = [], b = 0; e > b; b++) c = $.jgrid.getAccessor(d.p.data[b], a), void 0 === c && (c = String(b + 1)), d.p._index[c] = b
                    },
                    ...
                    L = function (a, b, c, e) {
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (H.call(d, false, true), b = 1);
                            var m, n, o, p, q, r, s, t, u, v, w = $(d),
                                x = 0,
                                z = d.p.multiselect === true ? 1 : 0,
                                A = 0,
                                B = d.p.rownumbers === true ? 1 : 0,
                                I = [],
                                J = {},
                                L = [],
                                M = d.p.altRows === true ? d.p.altclass : "",
                                N = k(l, "rowBox", true, "jqgrow ui-row-" + d.p.direction);
                            d.p.subGrid === true && (A = 1, p = $.jgrid.getMethod("addSubGridCell")), i.repeatitems || (I = F(j)), q = d.p.keyName === false ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName, r = -1 === String(q).indexOf("[") ? I.length ? function (a, b) {
                                return $(q, a).text() || b
                            } : function (a, b) {
                                return $(i.cell, a).eq(q).text() || b
                            } : function (a, b) {
                                return a.getAttribute(q.replace(/[\[\]]/g, "")) || b
                            }, d.p.userData = {}, d.p.page = y($.jgrid.getXmlData(a, i.page), d.p.page), d.p.lastpage = y($.jgrid.getXmlData(a, i.total), 1), d.p.records = y($.jgrid.getXmlData(a, i.records)), $.isFunction(i.userdata) ? d.p.userData = i.userdata.call(d, a) || {} : $.jgrid.getXmlData(a, i.userdata, true).each(function () {
                                d.p.userData[this.getAttribute("name")] = $(this).text()
                            });
                            var O = $.jgrid.getXmlData(a, i.root, true);
                            O = $.jgrid.getXmlData(O, i.row, true), O || (O = []);
                            var P, Q = O.length,
                                R = 0,
                                S = [],
                            ...
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                ...
                                var V, W = $.isFunction(d.p.afterInsertRow),
                                    ...
                                    Z = B ? k(l, "rownumBox", false, "jqgrid-rownum") : "",
                                    _ = z ? k(l, "multiBox", false, "cbox") : "";
                                for (d.p.grouping && (X = d.p.groupingView.groupCollapse === true, V = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
                                    t = O[R], u = r(t, U + R), u = d.p.idPrefix + u, P = 0 === b ? 0 : b + 1, v = N + ((P + R) % 2 === 1 ? " " + M : "");
                                    var ab = L.length;
                                    if (L.push(""), B && L.push(E(0, R, d.p.page, d.p.rowNum, Z)), z && L.push(D(u, B, R, false, _)), A && L.push(p.call(w, z + B, R + b)), i.repeatitems) {
                                        s || (s = G(z + A + B));
                                        var bb = $.jgrid.getXmlData(t, i.cell, true);
                                        $.each(s, function (a) {
                                            var c = bb[this];
                                            return c ? (o = c.textContent || c.text, J[d.p.colModel[a + z + A + B].name] = o, void L.push(C(u, o, a + z + A + B, R + b, t, J))) : false
                                        })
                                    } else
                                        for (m = 0; m < I.length; m++) o = $.jgrid.getXmlData(t, I[m]), J[d.p.colModel[m + z + A + B].name] = o, L.push(C(u, o, m + z + A + B, R + b, t, J)); if (L[ab] = K(u, X, v, J, t), L.push("</tr>"), d.p.grouping && (S.push(L), d.p.groupingView._locgr || V.call(w, J, R), L = []), (g || d.p.treeGrid === true && !d.p._ald) && (J[h] = $.jgrid.stripPref(d.p.idPrefix, u), d.p.data.push(J), d.p._index[J[h]] = d.p.data.length - 1), d.p.gridview === false && (Y.append(L.join("")), w.triggerHandler("jqGridAfterInsertRow", [u, J, t]), W && d.p.afterInsertRow.call(d, u, J, t), L = []), J = {}, x++, R++, x === T) break
                                }
                            }
                            if (d.p.gridview === true && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null) : d.p.treeGrid === true && n > 0 ? $(d.rows[n]).after(L.join("")) : (Y.append(L.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === true) try {
                                w.jqGrid("addSubGrid", z + B)
                            } catch (cb) {}
                            if (d.p.totaltime = new Date - f, x > 0 && 0 === d.p.records && (d.p.records = Q), L = null, d.p.treeGrid === true) try {
                                w.jqGrid("setTreeNode", n + 1, x + n + 1)
                            } catch (db) {}
                            if (d.p.reccount = x, d.p.treeANode = -1, d.p.userDataOnFooter && w.jqGrid("footerData", "set", d.p.userData, true), g && (d.p.records = Q, d.p.lastpage = Math.ceil(Q / T)), c || d.updatepager(false, true), g) {
                                for (; Q > x;) {
                                    if (t = O[x], u = r(t, x + U), u = d.p.idPrefix + u, i.repeatitems) {
                                        s || (s = G(z + A + B));
                                        var eb = $.jgrid.getXmlData(t, i.cell, true);
                                        $.each(s, function (a) {
                                            var b = eb[this];
                                            return b ? (o = b.textContent || b.text, void(J[d.p.colModel[a + z + A + B].name] = o)) : false
                                        })
                                    } else
                                ...
                                d.p.grouping && (d.p.groupingView._locgr = true, w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null)
                            }
                        }
                    },
                    M = function (a, b, c, e) {
                        ...
                        if (a) {
                            ...
                            var m, o, p, q, r, s, t, u, v, w, x, z, A = $(d),
                                ...
                                L = d.p.subGrid === true ? 1 : 0,
                                M = d.p.rownumbers === true ? 1 : 0,
                                N = G(J + L + M),
                                O = F(h),
                                P = {},
                                Q = [],
                                R = d.p.altRows === true ? d.p.altclass : "",
                                S = k(l, "rowBox", true, "jqgrow ui-row-" + d.p.direction);
                            d.p.page = y($.jgrid.getAccessor(a, g.page), d.p.page), d.p.lastpage = y($.jgrid.getAccessor(a, g.total), 1), d.p.records = y($.jgrid.getAccessor(a, g.records)), d.p.userData = $.jgrid.getAccessor(a, g.userdata) || {}, L && (r = $.jgrid.getMethod("addSubGridCell")), v = d.p.keyName === false ? $.isFunction(g.id) ? g.id.call(d, a) : g.id : d.p.keyName, u = $.jgrid.getAccessor(a, g.root), null == u && $.isArray(a) && (u = a), u || (u = []), t = u.length, o = 0, t > 0 && d.p.page <= 0 && (d.p.page = 1);
                            var T, U, V = parseInt(d.p.rowNum, 10),
                                W = d.p.scroll ? $.jgrid.randId() : 1,
                                X = false;
                            e && (V *= e + 1), "local" !== d.p.datatype || d.p.deselectAfterSort || (X = true);
                            var Y, Z = $.isFunction(d.p.afterInsertRow),
                                _ = [],
                                ab = false,
                                bb = $("#" + $.jgrid.jqID(d.p.id) + " tbody:first"),
                                cb = M ? k(l, "rownumBox", false, "jqgrid-rownum") : "",
                                db = J ? k(l, "multiBox", false, "cbox") : "";
                            for (d.p.grouping && (ab = d.p.groupingView.groupCollapse === true, Y = $.jgrid.getMethod("groupingPrepare")); t > o;) {
                                ...
                                if (z += U ? " " + n : "", Q[fb] = K(x, ab, z, P, q), Q.push("</tr>"), d.p.grouping && (_.push(Q), d.p.groupingView._locgr || Y.call(A, P, o), Q = []), (j || d.p.treeGrid === true && !d.p._ald) && (P[i] = $.jgrid.stripPref(d.p.idPrefix, x), d.p.data.push(P), d.p._index[P[i]] = d.p.data.length - 1), d.p.gridview === false && (bb.append(Q.join("")), A.triggerHandler("jqGridAfterInsertRow", [x, P, q]), Z && d.p.afterInsertRow.call(d, x, P, q), Q = []), P = {}, B++, o++, B === V) break
                            }
                            if (d.p.gridview === true && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === true && w > 0 ? $(d.rows[w]).after(Q.join("")) : (bb.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.subGrid === true) try {
                                A.jqGrid("addSubGrid", J + M)
                            } catch (gb) {}
                            if (d.p.totaltime = new Date - f, B > 0 && 0 === d.p.records && (d.p.records = t), Q = null, d.p.treeGrid === true) try {
                                A.jqGrid("setTreeNode", w + 1, B + w + 1)
                            } catch (hb) {}
                            if (d.p.reccount = B, d.p.treeANode = -1, d.p.userDataOnFooter && A.jqGrid("footerData", "set", d.p.userData, true), j && (d.p.records = t, d.p.lastpage = Math.ceil(t / V)), c || d.updatepager(false, true), j) {
                                for (; t > B && u[B];) {
                                ...
                                d.p.grouping && (d.p.groupingView._locgr = true, A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null)
                            }
                        }
                    },
                    N = function () {
                        ...
                        var b, c, e, f, g = d.p.multiSort ? [] : "",
                            ...
                            l = [];
                        if ($.isArray(d.p.data)) {
                            var m, n, o = d.p.grouping ? d.p.groupingView : false;
                            if ($.each(d.p.colModel, function () {
                                ...
                                d.p.multiSort || i || this.index !== d.p.sortname && this.name !== d.p.sortname || (g = this.name, i = true)
                            ...
                            if (d.p.ignoreCase && (q = q.ignoreCase()), d.p.search === true) {
                            ...
                            } else d.p.treeGrid && "nested" === d.p.treeGridModel && q.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null); if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (m = 0, g = null), d.p.grouping)
                    ...
                    O = function (a, b) {
                        ...
                        if (p = d.p.pager || "", p += d.p.toppager ? p ? "," + d.p.toppager : d.p.toppager : "") {
                            if (j = $.jgrid.getRegional(d, "formatter.integer"), c = y(d.p.page), e = y(d.p.lastpage), $(".selbox", p)[this.p.useProp ? "prop" : "attr"]("disabled", false), d.p.pginput === true && ($("#input" + r).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", false, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "'></span>")), d.p.toppager && $("#input_t" + s).html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input " + k(l, "pgInput", false, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>")), $(".ui-pg-input", p).val(d.p.page), n = d.p.toppager ? "#sp_1" + r + ",#sp_1" + r + "_toppager" : "#sp_1" + r, $(n).html($.fmatter ? $.fmatter.util.NumberFormat(d.p.lastpage, j) : d.p.lastpage)), d.p.viewrecords)
                        ...
                        a === true && d.p.rownumbers === true && $(">td.jqgrid-rownum", d.rows).each(function (a) {
                            $(this).html(f + 1 + a)
                    ...
                    P = function () {
                        d.grid.hDiv.loading = true, d.p.hiddengrid || $(d).jqGrid("progressBar", {
                            method: "show",
                            loadtype: d.p.loadui,
                    ...
                    Q = function () {
                        d.grid.hDiv.loading = false, $(d).jqGrid("progressBar", {
                            method: "hide",
                            loadtype: d.p.loadui
                        })
                    },
                    R = function (a) {
                        if (!d.grid.hDiv.loading) {
                            ...
                            if (a = a || 1, a > 1 ? null !== g.npage ? (f[g.npage] = a, j = a - 1, a = 1) : i = function (b) {
                                d.p.page++, d.grid.hDiv.loading = false, h && d.p.loadComplete.call(d, b), R(a - 1)
                            ...
                            if (p === false || "stop" === p) return;
                            if ($.isFunction(d.p.datatype)) return void d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j);
                            if ($.isFunction(d.p.beforeRequest) && (p = d.p.beforeRequest.call(d), void 0 === p && (p = true), p === false)) return;
                            ...
                            case "script":
                                $.ajax($.extend({
                                    ...
                                    success: function (c, f, g) {
                                        return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === false ? void Q() : ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && Q()))
                                    }, error: function (b, c, e) {
                                        $.isFunction(d.p.loadError) && d.p.loadError.call(d, b, c, e), 1 === a && Q(), b = null
                                    }, beforeSend: function (a, b) {
                                        var c = true;
                                        return $.isFunction(d.p.loadBeforeSend) && (c = d.p.loadBeforeSend.call(d, a, b)), void 0 === c && (c = true), c === false ? false : void P()
                                    }
                            ...
                            case "local":
                            case "clientside":
                                P(), d.p.datatype = "local", d.p._ald = true;
                                var q = N();
                                M(q, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [q]), i && i.call(d, q), $(d).triggerHandler("jqGridAfterLoadComplete", [q]), e && d.grid.populateVisible(), Q(), d.p._ald = false
                            }
                            d.p._sort = false
                        }
                    },
                    ...
                    T = function (a, b) {
                        var c, e, f, g, i, j, n, p = "<td class='ui-pg-button " + m + "'><span class='ui-separator'></span></td>",
                            ...
                            u = function (a, b) {
                                var c;
                                return $.isFunction(d.p.onPaging) && (c = d.p.onPaging.call(d, a, b)), "stop" === c ? false : (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], S(false)), d.p.savedRow = [], true)
                            };
                        if (a = a.substr(1), b += "_" + a, c = "pg_" + a, e = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table class='ui-pg-table ui-common-table ui-pager-table'><tbody><tr><td id='" + e + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), d.p.rowList.length > 0) {
                            t = '<td dir="' + h + '">', t += "<select " + k(l, "pgSelectBox", false, "ui-pg-selbox") + ' role="listbox" title="' + ($.jgrid.getRegional(d, "defaults.pgrecs", d.p.pgrecs) || "") + '">';
                            var v;
                        ...
                        if ("rtl" === h && (s += t), d.p.pginput === true && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === true) {
                            var w = ["first" + b, "prev" + b, "next" + b, "last" + b],
                                x = k(l, "pgButtonBox", true, "ui-pg-button"),
                            ...
                            "rtl" === h && (w.reverse(), z.reverse()), s += "<td id='" + w[0] + "' class='" + x + "' title='" + z[0] + "'><span " + k(l, "icon_first", false, q) + "></span></td>", s += "<td id='" + w[1] + "' class='" + x + "'  title='" + z[1] + "'><span " + k(l, "icon_prev", false, q) + "></span></td>", s += "" !== r ? p + r + p : "", s += "<td id='" + w[2] + "' class='" + x + "' title='" + z[2] + "'><span " + k(l, "icon_next", false, q) + "></span></td>", s += "<td id='" + w[3] + "' class='" + x + "' title='" + z[3] + "'><span " + k(l, "icon_end", false, q) + "></span></td>"
                        } else "" !== r && (s += r);
                        "ltr" === h && (s += t), s += "</tr></tbody></table>", d.p.viewrecords === true && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + h + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(d.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(d.p.id)).append("<div id='testpg' " + k(l, "entrieBox", false, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== r && (i += 50), $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)), d.p._nvtd = [], d.p._nvtd[0] = Math.floor(i ? (d.p.width - i) / 2 : d.p.width / 3), d.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).bind("change", function () {
                            return u("records", this) ? (d.p.page = Math.round(d.p.rowNum * (d.p.page - 1) / this.value - .5) + 1, d.p.rowNum = this.value, d.p.pager && $(".ui-pg-selbox", d.p.pager).val(this.value), d.p.toppager && $(".ui-pg-selbox", d.p.toppager).val(this.value), R(), false) : false
                        }), d.p.pgbuttons === true && ($(".ui-pg-button", "#" + c).hover(function () {
                            ...
                            if ($(this).hasClass(m)) return false;
                            var a = y(d.p.page, 1),
                                c = y(d.p.lastpage, 1),
                                e = false,
                                f = true,
                                ...
                                h = true,
                                i = true;
                            return 0 === c || 1 === c ? (f = false, g = false, h = false, i = false) : c > 1 && a >= 1 ? 1 === a ? (f = false, g = false) : a === c && (h = false, i = false) : c > 1 && 0 === a && (h = false, i = false, a = c - 1), u(this.id.split("_")[0], this) ? (this.id === "first" + b && f && (d.p.page = 1, e = true), this.id === "prev" + b && g && (d.p.page = a - 1, e = true), this.id === "next" + b && h && (d.p.page = a + 1, e = true), this.id === "last" + b && i && (d.p.page = c, e = true), e && R(), false) : false
                        })), d.p.pginput === true && $("#" + c).on("keypress", "input.ui-pg-input", function (a) {
                            var b = a.charCode || a.keyCode || 0;
                            return 13 === b ? u("user", this) ? ($(this).val(y($(this).val(), 1)), d.p.page = $(this).val() > 0 ? $(this).val() : d.p.page, R(), false) : false : this
                        })
                    },
                    U = function (a, b) {
                        ...
                        if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                            if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) U(b, f);
                                ...
                                var g, h = d.grid.headers[d.p.lastsort] ? d.grid.headers[d.p.lastsort].el : null,
                                    ...
                                    j = "single" === d.p.viewsortcols[1] ? true : false;
                            ...
                            if ("local" === d.p.datatype ? d.p.deselectAfterSort && $(d).jqGrid("resetSelection") : (d.p.selrow = null, d.p.multiselect && S(false), d.p.selarrrow = [], d.p.savedRow = []), d.p.scroll) {
                                var k = d.grid.bDiv.scrollLeft;
                                H.call(d, true, false), d.grid.hDiv.scrollLeft = k
                            }
                            d.p.subGrid && "local" === d.p.datatype && $("td.sgexpanded", "#" + $.jgrid.jqID(d.p.id)).each(function () {
                                $(this).trigger("click")
                            }), d.p._sort = true, R(), d.p.lastsort = b, d.p.sortname !== a && b && (d.p.lastsort = b)
                        }
                    },
                    W = function () {
                        var a, b, c, f, g = 0,
                        ...
                        $.each(d.p.colModel, function () {
                            if (void 0 === this.hidden && (this.hidden = false), d.p.grouping && d.p.autowidth) {
                            ...
                            this.widthOrg = b = y(this.width, 0), this.hidden === false && (g += b + h, this.fixed ? l += b + h : i++)
                        }), isNaN(d.p.width) && (d.p.width = g + (d.p.shrinkToFit !== false || isNaN(d.p.height) ? 0 : j)), e.width = d.p.width, d.p.tblwidth = g, d.p.shrinkToFit === false && d.p.forceFit === true && (d.p.forceFit = false), d.p.shrinkToFit === true && i > 0 && (c = e.width - h * i - l, isNaN(d.p.height) || (c -= j, k = true), g = 0, $.each(d.p.colModel, function (e) {
                            this.hidden !== false || this.fixed || (b = Math.round(c * this.width / (d.p.tblwidth - h * i - l)), this.width = b, g += b, a = e)
                ...
                for (this.p.id = this.id, -1 === $.inArray(d.p.multikey, x) && (d.p.multikey = false), d.p.keyName = false, i = 0; i < d.p.colModel.length; i++) w = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {} : d.p.colModel[i].template, d.p.colModel[i] = $.extend(true, {}, d.p.cmTemplate, w || {}, d.p.colModel[i]), d.p.keyName === false && d.p.colModel[i].key === true && (d.p.keyName = d.p.colModel[i].name);
                if (d.p.sortorder = d.p.sortorder.toLowerCase(), $.jgrid.cell_width = $.jgrid.cellWidth(), d.p.grouping === true && (d.p.scroll = false, d.p.rownumbers = false, d.p.treeGrid = false, d.p.gridview = true), this.p.treeGrid === true) {
                    try {
                ...
                }, d.p.xmlReader), d.p.jsonReader = $.extend(true, {
                    root: "rows",
                    page: "page",
                    total: "total",
                    records: "records",
                ...
                }, d.p.jsonReader), d.p.localReader = $.extend(true, {
                    root: "rows",
                    page: "page",
                    total: "total",
                    records: "records",
                ...
                }, d.p.localReader), d.p.scroll && (d.p.pgbuttons = false, d.p.pginput = false, d.p.rowList = []), d.p.data.length && (I(), J());
                var bb, cb, db, eb, fb, gb, hb, ib, jb = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                    kb = "",
                    lb = "",
                    mb = "";
                if (d.p.shrinkToFit === true && d.p.forceFit === true)
                    for (i = d.p.colModel.length - 1; i >= 0; i--)
                        if (!d.p.colModel[i].hidden) {
                            d.p.colModel[i].resizable = false;
                            break
                        }
                if ("horizontal" === d.p.viewsortcols[1] ? (lb = " ui-i-asc", mb = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (lb = " ui-single-sort-asc", mb = " ui-single-sort-desc", kb = " style='display:none'", d.p.viewsortcols[0] = false), bb = r ? "class='ui-th-div-ie'" : "", ib = "<span class='s-ico' style='display:none'>", ib += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + lb + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", true) + "'" + kb + "></span>", ib += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + mb + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", true) + "'" + kb + "></span></span>", d.p.multiSort && d.p.sortname)
                ...
                for (i = 0; i < this.p.colNames.length; i++) {
                    ...
                    jb += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' " + k(l, "headerBox", false, "ui-th-column ui-th-" + h) + " " + nb + ">", cb = d.p.colModel[i].index || d.p.colModel[i].name, jb += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + bb + ">" + d.p.colNames[i], d.p.colModel[i].width = d.p.colModel[i].width ? parseInt(d.p.colModel[i].width, 10) : 150, "boolean" != typeof d.p.colModel[i].title && (d.p.colModel[i].title = true), d.p.colModel[i].lso = "", cb === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (u = $.inArray(cb, s), -1 !== u && (d.p.colModel[i].lso = t[u])), jb += ib + "</div></th>"
                }
                if (jb += "</tr></thead>", ib = null, $(this).append(jb), $("thead tr:first th", this).hover(function () {
                    ...
                    $("#cb_" + $.jgrid.jqID(d.p.id), this).bind("click", function () {
                        d.p.selarrrow = [];
                        var a = d.p.frozenColumns === true ? d.p.id + "_frozen" : "";
                        this.checked ? ($(d.rows).each(function (b) {
                            b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(m) || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", true), $(this).addClass(n).attr("aria-selected", "true"), d.p.selarrrow.push(this.id), d.p.selrow = this.id, a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", true), $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).addClass(n))))
                        }), ob = true, pb = []) : ($(d.rows).each(function (b) {
                            b > 0 && ($(this).hasClass("ui-subgrid") || $(this).hasClass("jqgroup") || $(this).hasClass(m) || $(this).hasClass("jqfoot") || ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", false), $(this).removeClass(n).attr("aria-selected", "false"), pb.push(this.id), a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", false), $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).removeClass(n))))
                        }), d.p.selrow = null, ob = false), $(d).triggerHandler("jqGridSelectAll", [ob ? d.p.selarrrow : pb, ob]), $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, ob ? d.p.selarrrow : pb, ob)
                    })
                }
                ...
                W(), $(v).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"), d.p.scrollPopUp && $(v).append("<div " + k(l, "scrollBox", false, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"), $(j).css("width", e.width + "px"), jb = $("thead:first", d).get(0);
                var rb = "";
                d.p.footerrow && (rb += "<table role='presentation' style='width:" + d.p.tblwidth + "px' " + k(l, "footerTable", false, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + k(l, "footerBox", false, "footrow footrow-" + h) + ">");
                var sb = $("tr:first", jb),
                    tb = "<tr class='jqgfirstrow' role='row'>";
                if (d.p.disableClick = false, $("th", sb).each(function (a) {
                    db = d.p.colModel[a].width, void 0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = true), d.p.colModel[a].resizable ? (eb = document.createElement("span"), $(eb).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : eb = "", $(this).css("width", db + "px").prepend(eb), eb = null;
                    var b = "";
                    ...
                    if (1 === f.length) {
                        ...
                        if (d.p.frozenColumns) {
                            ...
                            $(d.p.colModel).each(function (a) {
                                return this.name === h ? (g = a, false) : void 0
                            })
                        } else g = Z(this);
                        return d.p.viewsortcols[2] || (b = true, c = f.attr("sort")), null != g && V($("div", this)[0].id, g, b, c, this), false
                    }
                }), d.p.sortable && $.fn.sortable) try {
                    $(d).jqGrid("sortableColumns", sb)
                } catch (ub) {}
                d.p.footerrow && (rb += "</tr></tbody></table>"), tb += "</tr>", hb = document.createElement("tbody"), this.appendChild(hb), $(this).addClass(k(l, "rowTable", true, "ui-jqgrid-btable ui-common-table")).append(tb), tb = null;
                var vb = $("<table " + k(l, "headerTable", false, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(jb),
                    wb = d.p.caption && d.p.hiddengrid === true ? true : false,
                    xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
                jb = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", true, "ui-jqgrid-hdiv"), $(e.hDiv).append(xb), $(xb).append(vb), vb = null, wb && $(e.hDiv).hide(), d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({
                    width: e.width + "px"
                }).addClass(k(l, "pagerBox", true, "ui-jqgrid-pager")).appendTo(v), wb && $(d.p.pager).hide(), T(d.p.pager, "")), d.p.cellEdit === false && d.p.hoverrows === true && $(d).bind("mouseover", function (a) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    if (c = c === false || "stop" === c ? false : true, $.isFunction(d.p.beforeSelectRow)) {
                        var e = d.p.beforeSelectRow.call(d, gb[0].id, a);
                        (e === false || "stop" === e) && (c = false)
                    }
                    if ("A" !== fb.tagName && ("INPUT" !== fb.tagName && "TEXTAREA" !== fb.tagName && "OPTION" !== fb.tagName && "SELECT" !== fb.tagName || b)) {
                        if (yb = gb[0].id, fb = $(fb).closest("tr.jqgrow>td"), fb.length > 0 && (zb = $.jgrid.getCellIndex(fb), Ab = $(fb).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [yb, zb, Ab, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, yb, zb, Ab, a)), d.p.cellEdit === true)
                            if (d.p.multiselect && b && c) $(d).jqGrid("setSelection", yb, true, a);
                            else if (fb.length > 0) {
                            yb = gb[0].rowIndex;
                            try {
                                $(d).jqGrid("editCell", yb, zb, true)
                            } catch (f) {}
                        }
                        if (c)
                            if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", yb, true, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + yb)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                            else if (d.p.multiselect && d.p.multiboxonly)
                            if (b) $(d).jqGrid("setSelection", yb, true, a);
                            else {
                                var g = d.p.frozenColumns ? d.p.id + "_frozen" : "";
                                $(d.p.selarrrow).each(function (a, b) {
                                    var c = $(d).jqGrid("getGridRowById", b);
                                    c && $(c).removeClass(n), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", false), g && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g)).removeClass(n), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(g))[d.p.useProp ? "prop" : "attr"]("checked", false))
                                }), d.p.selarrrow = [], $(d).jqGrid("setSelection", yb, true, a)
                            } else $(d).jqGrid("setSelection", yb, true, a)
                    }
                }).bind("reloadGrid", function (a, b) {
                    if (d.p.treeGrid === true && (d.p.datatype = d.p.treedatatype), b = b || {}, b.current && d.grid.selectionPreserver(d), "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (I(), J())) : d.p.treeGrid || (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], S(false)), d.p.savedRow = []), d.p.scroll && H.call(d, true, false), b.page) {
                        var c = b.page;
                    ...
                    return d.grid.prevRowHeight && d.p.scroll && void 0 === b.page ? (delete d.p.lastpage, d.grid.populateVisible()) : d.grid.populate(), d.p.inlineNav === true && $(d).jqGrid("showAddEditButtons"), false
                }).dblclick(function (a) {
                    ...
                    if (fb = a.target, gb = $(fb, d.rows).closest("tr.jqgrow"), 0 !== $(gb).length) {
                        d.p.multiselect || $(d).jqGrid("setSelection", gb[0].id, true, a), yb = gb[0].rowIndex, zb = $.jgrid.getCellIndex(fb);
                ...
                var Bb = q + " " + k(l, "icon_caption_open", true),
                    Cb = q + " " + k(l, "icon_caption_close", true);
                e.cDiv = document.createElement("div");
                var Db = d.p.hidegrid === true ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function () {
                    Db.addClass(o)
                }, function () {
                    Db.removeClass(o)
                }).append("<span class='ui-jqgrid-headlink " + Bb + "'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
                if ($(e.cDiv).append(Db).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", true)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var Eb = k(l, "customtoolbarBox", true, "ui-userdata");
                ...
                if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager", e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0], d.p.toppager = "#" + d.p.toppager, $(e.topDiv).addClass(k(l, "toppagerBox", true, "ui-jqgrid-toppager")).width(e.width).insertBefore(e.hDiv), T(d.p.toppager, "_t")), d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], xb = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), $(e.sDiv).append(xb).width(e.width).insertAfter(e.hDiv), $(xb).append(rb), e.footers = $(".ui-jqgrid-ftable", e.sDiv)[0].rows[0].cells, d.p.rownumbers && (e.footers[0].className = k(l, "rownumBox", true, "jqgrid-rownum")), wb && $(e.sDiv).hide()), xb = null, d.p.caption) {
                    ...
                    d.p.hidegrid === true && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
                        ...
                        return d.p.toolbar[0] === true && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), f += ", #" + $(e.uDiv).attr("id")), b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length, "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function () {
                            ...
                            b--, 0 === b && ($("span", g).removeClass(Cb).addClass(Bb), wb && (d.p.datatype = Fb, R(), wb = false), d.p.gridstate = "visible", $("#gbox_" + $.jgrid.jqID(d.p.id)).hasClass("ui-resizable") && $(".ui-resizable-handle", "#gbox_" + $.jgrid.jqID(d.p.id)).show(), $(d).triggerHandler("jqGridHeaderClick", [d.p.gridstate, a]), c && (wb || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }), false
                    }), wb && (d.p.datatype = "local", $(".ui-jqgrid-titlebar-close", e.cDiv).trigger("click")))
                } else $(e.cDiv).hide(), d.p.toppager || $(e.hDiv).addClass(k(d.p.styleUI + ".common", "cornertop", true)); if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
                    return e.resizing ? (e.dragMove(a), false) : void 0
                }), $(".ui-jqgrid-labels", e.hDiv).bind("selectstart", function () {
                    return false
                }), $(document).bind("mouseup.jqGrid" + d.p.id, function () {
                    return e.resizing ? (e.dragEnd(true), false) : true
                    ...
                    M(a)
                }, this.grid.cols = this.rows[0].cells, $(d).triggerHandler("jqGridInitGrid"), $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d), R(), d.p.hiddengrid = false, d.p.responsive) {
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                if (null == b && (b = false), this.grid && "object" == typeof a)
                    if (b === true) {
                        var c = $.extend({}, this.p, a);
                        this.p = c
                    } else $.extend(true, this.p, a)
            })
            ...
            return this.each(function () {
                ...
                var e, f, g, h, i, j, k, l = this,
                    ...
                    n = m(l.p.styleUI + ".common", "highlight", true),
                    o = m(l.p.styleUI + ".common", "disabled", true);
                void 0 !== a && (b = b === false ? false : true, f = $(l).jqGrid("getGridRowById", a), !f || !f.className || f.className.indexOf(o) > -1 || (l.p.scrollrows === true && (g = $(l).jqGrid("getGridRowById", a).rowIndex, g >= 0 && d(g)), l.p.frozenColumns === true && (j = l.p.id + "_frozen"), l.p.multiselect ? (l.setHeadCheckBox(false), l.p.selrow = f.id, h = $.inArray(l.p.selrow, l.p.selarrrow), -1 === h ? ("ui-subgrid" !== f.className && $(f).addClass(n).attr("aria-selected", "true"), e = true, l.p.selarrrow.push(l.p.selrow)) : ("ui-subgrid" !== f.className && $(f).removeClass(n).attr("aria-selected", "false"), e = false, l.p.selarrrow.splice(h, 1), i = l.p.selarrrow[0], l.p.selrow = void 0 === i ? null : i), $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(f.id))[l.p.useProp ? "prop" : "attr"]("checked", e), j && (-1 === h ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass(n) : $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).removeClass(n), $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j))[l.p.useProp ? "prop" : "attr"]("checked", e)), b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]), l.p.onSelectRow && l.p.onSelectRow.call(l, f.id, e, c))) : "ui-subgrid" !== f.className && (l.p.selrow !== f.id ? (k = $(l).jqGrid("getGridRowById", l.p.selrow), k && $(k).removeClass(n).attr({
                    "aria-selected": "false",
                    tabindex: "-1"
                }), $(f).addClass(n).attr({
                    "aria-selected": "true",
                    tabindex: "0"
                }), j && ($("#" + $.jgrid.jqID(l.p.selrow), "#" + $.jgrid.jqID(j)).removeClass(n), $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass(n)), e = true) : e = false, l.p.selrow = f.id, b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]), l.p.onSelectRow && l.p.onSelectRow.call(l, f.id, e, c)))))
            })
        }, resetSelection: function (a) {
            return this.each(function () {
                var b, c, d = this,
                    e = $.jgrid.getMethod("getStyleUI"),
                    f = e(d.p.styleUI + ".common", "highlight", true),
                    g = e(d.p.styleUI + ".common", "hover", true);
                if (d.p.frozenColumns === true && (c = d.p.id + "_frozen"), void 0 !== a) {
                    if (b = a === d.p.selrow ? d.p.selrow : a, $("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(b)).removeClass(f).attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass(f), d.p.multiselect) {
                        $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(d.p.id))[d.p.useProp ? "prop" : "attr"]("checked", false), c && $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c))[d.p.useProp ? "prop" : "attr"]("checked", false), d.setHeadCheckBox(false);
                    ...
                    $($(d).jqGrid("getGridRowById", b)).removeClass(f).attr("aria-selected", "false"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b))[d.p.useProp ? "prop" : "attr"]("checked", false), c && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c)).removeClass(f), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(c))[d.p.useProp ? "prop" : "attr"]("checked", false)), d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, b)
                }), d.setHeadCheckBox(false), d.p.selarrrow = [], d.p.selrow = null) : d.p.selrow && ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(d.p.selrow)).removeClass(f).attr("aria-selected", "false"), c && $("#" + $.jgrid.jqID(d.p.selrow), "#" + $.jgrid.jqID(c)).removeClass(f), d.p.onUnSelectRow && d.p.onUnSelectRow.call(d, d.p.selrow), d.p.selrow = null);
                d.p.cellEdit === true && parseInt(d.p.iCol, 10) >= 0 && parseInt(d.p.iRow, 10) >= 0 && ($("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell " + f), $(d.rows[d.p.iRow]).removeClass("selected-row " + g)), d.p.savedRow = []
            })
            ...
            return this.each(function () {
                var h, i, j = this;
                if (null == a) f = true, c = [], d = j.rows.length;
                else {
                    if (i = $(j).jqGrid("getGridRowById", a), !i) return e;
                    d = 2
                }
                for (b && b === true && j.p.data.length > 0 || (b = false); d > g;) f && (i = j.rows[g]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function (a) {
                    if (h = j.p.colModel[a].name, "cb" !== h && "subgrid" !== h && "rn" !== h)
                        if (j.p.treeGrid === true && h === j.p.ExpandColumn) e[h] = $.jgrid.htmlDecode($("span:first", this).html());
                        else try {
            ...
            return this.each(function () {
                ...
                var g, h, i = this,
                    j = typeof c,
                    k = {};
                if (h = $(this).jqGrid("getGridRowById", a), !h) return false;
                if (b) try {
                    if ($(this.p.colModel).each(function (c) {
                        ...
                        } : {}, i.p.treeGrid === true && d === i.p.ExpandColumn ? $("td[role='gridcell']:eq(" + c + ") > span:first", h).html(g).attr(e) : $("td[role='gridcell']:eq(" + c + ")", h).html(g).attr(e))
                    }), "local" === i.p.datatype) {
                        var l, m = $.jgrid.stripPref(i.p.idPrefix, a),
                            n = i.p._index[m];
                        if (i.p.treeGrid)
                            for (l in i.p.treeReader) i.p.treeReader.hasOwnProperty(l) && delete k[i.p.treeReader[l]];
                        void 0 !== n && (i.p.data[n] = $.extend(true, i.p.data[n], k)), k = null
                    }
                } catch (o) {
                    f = false
                }
            ...
            var e, f, g, h, i, j, k, l, m, n, o, p, q, r, s = false,
                t = "",
                u = "",
                v = "";
            return b && ($.isArray(b) ? (m = true, n = a) : (b = [b], m = false), this.each(function () {
                var w = this,
                    x = b.length;
                i = w.p.rownumbers === true ? 1 : 0, g = w.p.multiselect === true ? 1 : 0, h = w.p.subGrid === true ? 1 : 0, m || (void 0 !== a ? a = String(a) : (a = $.jgrid.randId(), w.p.keyName !== false && (n = w.p.keyName, void 0 !== b[0][n] && (a = b[0][n])))), o = w.p.altclass;
                var y, z = 0,
                    A = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rowBox", true, "jqgrow ui-row-" + w.p.direction),
                    B = {},
                    C = $.isFunction(w.p.afterInsertRow) ? true : false;
                for (i && (t = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rownumBox", false, "jqgrid-rownum")), g && (u = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "multiBox", false, "cbox")); x > z;) {
                    if (p = b[z], f = [], y = A, m) {
                        try {
                        ...
                        y += w.p.altRows === true && (w.rows.length - 1) % 2 === 0 ? " " + o : ""
                    }
                    for (r = a, a = w.p.idPrefix + a, i && (v = w.formatCol(0, 1, "", null, a, true), f[f.length] = '<td role="gridcell" ' + t + " " + v + ">0</td>"), g && (l = '<input role="checkbox" type="checkbox" id="jqg_' + w.p.id + "_" + a + '" ' + u + "/>", v = w.formatCol(i, 1, "", null, a, true), f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>"), h && (f[f.length] = $(w).jqGrid("addSubGridCell", g + i, 1)), k = g + h + i; k < w.p.colModel.length; k++) q = w.p.colModel[k], e = q.name, B[e] = p[e], l = w.formatter(a, $.jgrid.getAccessor(p, e), k, p), v = w.formatCol(k, 1, l, p, a, B), f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>";
                    if (f.unshift(w.constructTr(a, false, y, B, p)), f[f.length] = "</tr>", 0 === w.rows.length) $("table:first", w.grid.bDiv).append(f.join(""));
                    else switch (c) {
                    case "last":
                    ...
                    w.p.subGrid === true && $(w).jqGrid("addSubGrid", g + i, j), w.p.records++, w.p.reccount++, $(w).triggerHandler("jqGridAfterInsertRow", [a, p, p]), C && w.p.afterInsertRow.call(w, a, p, p), z++, "local" === w.p.datatype && (B[w.p.localReader.id] = r, w.p._index[r] = w.p.data.length, w.p.data.push(B), B = {})
                }
                w.p.altRows !== true || m || ("last" === c ? (w.rows.length - 1) % 2 === 0 && $(w.rows[w.rows.length - 1]).addClass(o) : $(w.rows).each(function (a) {
                    a % 2 === 0 ? $(this).addClass(o) : $(this).removeClass(o)
                })), w.updatepager(true, true), s = true
            })), s
            ...
            var e, f, g = false,
                h = {};
            return void 0 === a && (a = "get"), "boolean" != typeof c && (c = true), a = a.toLowerCase(), this.each(function () {
                var i, j = this;
                return j.grid && j.p.footerrow ? "set" === a && d(b) ? false : (g = true, void $(this.p.colModel).each(function (d) {
                    e = this.name, "set" === a ? void 0 !== b[e] && (i = c ? j.formatter("", b[e], d, b, "edit") : b[e], f = this.title ? {
                        title: $.jgrid.stripHtml(i)
                    } : {}, $("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html(i).attr(f), g = true) : "get" === a && (h[e] = $("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html())
                })) : false
            }), "get" === a ? h : g
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    ...
                    if (h && $(d).jqGrid("destroyGroupHeader", false), $(this.p.colModel).each(function (h) {
                        if (-1 !== $.inArray(this.name, a) && this.hidden === g) {
                            if (d.p.frozenColumns === true && this.frozen === true) return true;
                            ...
                            }), d.p.footerrow && $("tr.footrow td:eq(" + h + ")", d.grid.sDiv).css("display", b), c = parseInt(this.width, 10), "none" === b ? d.p.tblwidth -= c + f : d.p.tblwidth += c + f, this.hidden = !g, e = true, $(d).triggerHandler("jqGridShowHideCol", [g, this.name, h])
                        }
                    }), e === true && (d.p.shrinkToFit !== true || isNaN(d.p.height) || (d.p.tblwidth += parseInt(d.p.scrollOffset, 10)), $(d).jqGrid("setGridWidth", d.p.shrinkToFit === true ? d.p.tblwidth : d.p.width)), h) {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if ("boolean" != typeof b && (b = g.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a + "px"), $(g.grid.hDiv).css("width", a + "px"), g.p.pager && $(g.p.pager).css("width", a + "px"), g.p.toppager && $(g.p.toppager).css("width", a + "px"), g.p.toolbar[0] === true && ($(g.grid.uDiv).css("width", a + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a + "px"), b === false && g.p.forceFit === true && (g.p.forceFit = false), b === true) {
                            if ($.each(g.p.colModel, function () {
                                this.hidden === false && (c = this.widthOrg, h += c + i, this.fixed ? m += c + i : j++)
                            }), 0 === j) return;
                            g.p.tblwidth = h, e = a - i * j - m, isNaN(g.p.height) || ($(g.grid.bDiv)[0].clientHeight < $(g.grid.bDiv)[0].scrollHeight || 1 === g.rows.length) && (k = true, e -= l), h = 0;
            ...
            return this.each(function () {
                ...
                if (b.grid) {
                    ...
                    c.css({
                        height: a + (isNaN(a) ? "" : "px")
                    }), b.p.frozenColumns === true && $("#" + $.jgrid.jqID(b.p.id) + "_frozen").parent().height(c.height() - 16), b.p.height = a, b.p.scroll && b.grid.populateVisible()
                }
            })
        }, setCaption: function (a) {
            return this.each(function () {
                var b = $(this).jqGrid("getStyleUI", this.p.styleUI + ".common", "cornertop", true);
            ...
            return this.each(function () {
                ...
                if (e.grid && void 0 !== a && ($(e.p.colModel).each(function (b) {
                    return this.name === a ? (f = b, false) : void 0
                }), f >= 0)) {
            ...
            return this.each(function () {
                ...
                if (i.grid && (isNaN(b) ? $(i.p.colModel).each(function (a) {
                    return this.name === b ? (j = a, false) : void 0
                }) : j = parseInt(b, 10), j >= 0)) {
            ...
            return this.each(function () {
                ...
                if (d.grid && (isNaN(b) ? $(d.p.colModel).each(function (a) {
                    return this.name === b ? (e = a, false) : void 0
                }) : e = parseInt(b, 10), e >= 0)) {
            ...
            var d, e, f, g, h = [],
                i = 0;
            return b = "boolean" != typeof b ? false : b, void 0 === c && (c = false), this.each(function () {
                var j = this,
                    k = -1;
                if (j.grid && (isNaN(a) ? $(j.p.colModel).each(function (b) {
                    return this.name === a ? (k = b, false) : void 0
                }) : k = parseInt(a, 10), k >= 0)) {
                    var l = j.rows.length,
                        m = 0,
                        n = 0;
            ...
            return this.each(function () {
                var b = this;
                if (b.grid) {
                    if ("boolean" != typeof a && (a = false), b.p.deepempty) $("#" + $.jgrid.jqID(b.p.id) + " tbody:first tr:gt(0)").remove();
                    else {
                        var c = $("#" + $.jgrid.jqID(b.p.id) + " tbody:first tr:first")[0];
                        $("#" + $.jgrid.jqID(b.p.id) + " tbody:first").empty().append(c)
                    }
                    b.p.footerrow && a && $(".ui-jqgrid-ftable td", b.grid.sDiv).html("&#160;"), b.p.selrow = null, b.p.selarrrow = [], b.p.savedRow = [], b.p.records = 0, b.p.page = 1, b.p.lastpage = 0, b.p.reccount = 0, b.p.data = [], b.p._index = {}, b.updatepager(true, false)
                }
            })
        }, getInd: function (a, b) {
            var c, d = false;
            return this.each(function () {
                c = $(this).jqGrid("getGridRowById", a), c && (d = b === true ? c : c.rowIndex)
            }), d
        }, bindKeys: function (a) {
            var b = $.extend({
                onEnter: null,
                    ...
                    if (g)
                        if (f = a.p._index[$.jgrid.stripPref(a.p.idPrefix, g.id)], 37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode) {
                            if (38 === c.keyCode) {
                                ...
                                $(a).jqGrid("setSelection", d, true, c), c.preventDefault()
                            }
                            if (40 === c.keyCode) {
            ...
            return a = $.extend({
                ...
                var b, c, d = "show" === a.method ? true : false,
            ...
            return this.each(function () {
                if (this.grid && b) {
                    ...
                    for (c = 0; c < d.length; c++)
                        if (d[c].name === a) {
                            $.extend(true, this.p.colModel[c], b);
                            break
                        }
                }
            })
                ...
                if (e.grid) {
                    for (a || (a = e.p.sortname), d = 0; d < e.p.colModel.length; d++)
                        if (e.p.colModel[d].index === a || e.p.colModel[d].name === a) {
                            f = d, e.p.frozenColumns === true && e.p.colModel[d].frozen === true && (g = e.grid.fhDiv.find("#" + e.p.id + "_" + a));
                            break
                        }
                    if (-1 !== f) {
                        var h = e.p.colModel[f].sortable;
                        g || (g = e.grid.headers[f].el), "boolean" != typeof h && (h = true), "boolean" != typeof b && (b = false), h && e.sortData("jqgh_" + e.p.id + "_" + a, f, b, c, g)
                    }
                }
            })
            ...
            return this.each(function () {
                if (this.grid) {
                    var b = this,
                        c = $(this).jqGrid("getStyleUI", this.p.styleUI + ".base", "icon_caption_open", true),
                        d = $(this).jqGrid("getStyleUI", this.p.styleUI + ".base", "icon_caption_close", true);
                    "hidden" === a ? ($(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideUp("fast"), b.p.pager && $(b.p.pager).slideUp("fast"), b.p.toppager && $(b.p.toppager).slideUp("fast"), b.p.toolbar[0] === true && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideUp("fast"), $(b.grid.uDiv).slideUp("fast")), b.p.footerrow && $(".ui-jqgrid-sdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideUp("fast"), $(".ui-jqgrid-headlink", b.grid.cDiv).removeClass(c).addClass(d), b.p.gridstate = "hidden") : "visible" === a && ($(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideDown("fast"), b.p.pager && $(b.p.pager).slideDown("fast"), b.p.toppager && $(b.p.toppager).slideDown("fast"), b.p.toolbar[0] === true && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideDown("fast"), $(b.grid.uDiv).slideDown("fast")), b.p.footerrow && $(".ui-jqgrid-sdiv", "#gbox_" + $.jgrid.jqID(b.p.id)).slideDown("fast"), $(".ui-jqgrid-headlink", b.grid.cDiv).removeClass(d).addClass(c), b.p.gridstate = "visible")
                }
            })
            ...
            return this.each(function () {
                if (this.grid) {
                    var a = this,
                        ...
                        e = -1,
                        f = false,
                        g = $(a).jqGrid("getStyleUI", a.p.styleUI + ".base", "headerDiv", true, "ui-jqgrid-hdiv"),
                        h = $(a).jqGrid("getStyleUI", a.p.styleUI + ".common", "hover", true);
                    if (a.p.subGrid !== true && a.p.treeGrid !== true && a.p.cellEdit !== true && !a.p.sortable && !a.p.scroll) {
                        for (a.p.rownumbers && c++, a.p.multiselect && c++; d > c && b[c].frozen === true;) f = true, e = c, c++;
                        if (e >= 0 && f) {
                            var i = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0,
                                j = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                            a.p.toppager && (i += $(a.grid.topDiv).outerHeight()), a.p.toolbar[0] === true && "bottom" !== a.p.toolbar[1] && (i += $(a.grid.uDiv).outerHeight()), a.grid.fhDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + i + "px;height:" + j + 'px;" class="frozen-div ' + g + '"></div>'), a.grid.fbDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(i, 10) + parseInt(j, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'), $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);
                            var k = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(true);
                            if (a.p.groupHeader) {
                                ...
                                $("tr.jqg-second-row-header th", k).each(function () {
                                    return l = parseInt($(this).attr("colspan"), 10), m = parseInt($(this).attr("rowspan"), 10), m && (n++, o++), l && (n += l, o++), n === e ? (o = e, false) : void 0
                                ...
                                return a.grid.resizing ? (a.grid.dragMove(b), false) : void 0
                            }), a.p.footerrow) {
                                ...
                                var q = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(true);
                                $("tr", q).each(function () {
                                    $("td:gt(" + e + ")", this).remove()
                            ...
                            }), a.p.hoverrows === true && $("#" + $.jgrid.jqID(a.p.id)).unbind("mouseover").unbind("mouseout"), $(a).bind("jqGridAfterGridComplete.setFrozenColumns", function () {
                                $("#" + $.jgrid.jqID(a.p.id) + "_frozen").remove(), $(a.grid.fbDiv).height($(a.grid.bDiv).height() - 16);
                                var b = $("#" + $.jgrid.jqID(a.p.id)).clone(true);
                                $("tr[role=row]", b).each(function () {
                                    $("td[role=gridcell]:gt(" + e + ")", this).remove()
                                }), $(b).width(1).attr("id", a.p.id + "_frozen"), $(a.grid.fbDiv).append(b), a.p.hoverrows === true && ($("tr.jqgrow", b).hover(function () {
                            ...
                            }), a.grid.hDiv.loading || $(a).triggerHandler("jqGridAfterGridComplete"), a.p.frozenColumns = true
                        }
                    }
                }
            })
            ...
            return this.each(function () {
                if (this.grid && this.p.frozenColumns === true) {
                    var a = this,
                        b = $(a).jqGrid("getStyleUI", a.p.styleUI + ".common", "hover", true);
                    if ($(a.grid.fhDiv).remove(), $(a.grid.fbDiv).remove(), a.grid.fhDiv = null, a.grid.fbDiv = null, a.p.footerrow && ($(a.grid.fsDiv).remove(), a.grid.fsDiv = null), $(this).unbind(".setFrozenColumns"), a.p.hoverrows === true) {
                        var c;
            ...
            return this.each(function () {
                ...
                if ("string" == typeof a) {
                ...
                } else a = parseInt(a, 10); if (b = parseInt(b, 10), !("number" != typeof a || 0 > a || a > h.length - 1 || "number" != typeof b || b < g.minColWidth)) {
                    if (g.forceFit)
                    ...
                    f.newWidth = g.tblwidth + d, f.headers[a].newWidth = b, f.dragEnd(false)
                }
            })
        ...
        editCell: function (a, b, c) {
            return this.each(function () {
                var d, e, f, g, h = this,
                    i = $(this).jqGrid("getStyleUI", h.p.styleUI + ".common", "highlight", true),
                    j = $(this).jqGrid("getStyleUI", h.p.styleUI + ".common", "hover", true),
                    k = $(this).jqGrid("getStyleUI", h.p.styleUI + ".celledit", "inputClass", true);
                if (h.grid && h.p.cellEdit === true) {
                    if (b = parseInt(b, 10), h.p.selrow = h.rows[a].id, h.p.knv || $(h).jqGrid("GridNav"), h.p.savedRow.length > 0) {
                        if (c === true && a == h.p.iRow && b == h.p.iCol) return;
                        $(h).jqGrid("saveCell", h.p.savedRow[0].id, h.p.savedRow[0].ic)
                    } else window.setTimeout(function () {
                        $("#" + $.jgrid.jqID(h.p.knv)).attr("tabindex", "-1").focus()
                    }, 1); if (g = h.p.colModel[b], d = g.name, "subgrid" !== d && "cb" !== d && "rn" !== d) {
                        if (f = $("td:eq(" + b + ")", h.rows[a]), g.editable !== true || c !== true || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b)) parseInt(h.p.iCol, 10) >= 0 && parseInt(h.p.iRow, 10) >= 0 && $(h.rows[h.p.iRow]).removeClass("selected-row " + j).find("td:eq(" + h.p.iCol + ")").removeClass("edit-cell " + i), f.addClass("edit-cell " + i), $(h.rows[a]).addClass("selected-row " + j), e = f.html().replace(/\&#160\;/gi, ""), $(h).triggerHandler("jqGridSelectCell", [h.rows[a].id, d, e, a, b]), $.isFunction(h.p.onSelectCell) && h.p.onSelectCell.call(h, h.rows[a].id, d, e, a, b);
                        else {
                            ...
                            var n = $.extend({}, g.editoptions || {}, {
                                ...
                                o = $.jgrid.createEl.call(h, g.edittype, n, e, true, $.extend({}, $.jgrid.ajaxOptions, h.p.ajaxSelectOptions || {}));
                            $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(o).addClass(k), $(f).html("").append(o).attr("tabindex", "0"), $.jgrid.bindEv.call(h, o, n), window.setTimeout(function () {
                                ...
                                if (27 === c.keyCode && ($("input.hasDatepicker", f).length > 0 ? $(".ui-datepicker").is(":hidden") ? $(h).jqGrid("restoreCell", a, b) : $("input.hasDatepicker", f).datepicker("hide") : $(h).jqGrid("restoreCell", a, b)), 13 === c.keyCode && !c.shiftKey) return $(h).jqGrid("saveCell", a, b), false;
                                if (9 === c.keyCode) {
                                    if (h.grid.hDiv.loading) return false;
                            ...
                            if (s[0] === true) {
                                ...
                                if ($.isFunction(d.p.beforeSubmitCell) && (t = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b), t || (t = {})), $("input.hasDatepicker", i).length > 0 && $("input.hasDatepicker", i).datepicker("hide"), "remote" === d.p.cellsubmit)
                                    if (d.p.cellurl) {
                                        ...
                                        x = d.p.prmNames, v = x.id, w = x.oper, u[v] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id), u[w] = x.editoper, u = $.extend(t, u), $(d).jqGrid("progressBar", {
                                        ...
                                        }), d.grid.hDiv.loading = true, $.ajax($.extend({
                                            url: d.p.cellurl,
                                            ...
                                            complete: function (c, j) {
                                                if ($(d).jqGrid("progressBar", {
                                                    method: "hide",
                                                    loadtype: d.p.loadui
                                                }), d.grid.hDiv.loading = false, "success" === j) {
                                                    var l = $(d).triggerHandler("jqGridAfterSubmitCell", [d, c, u.id, k, g, a, b]) || [true, ""];
                                                    l[0] === true && $.isFunction(d.p.afterSubmitCell) && (l = d.p.afterSubmitCell.call(d, c, u.id, k, g, a, b)), l[0] === true ? ($(i).empty(), $(d).jqGrid("setCell", d.rows[a].id, b, h, false, false, true), $(i).addClass("dirty-cell"), $(d.rows[a]).addClass("edited"), $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]), $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b), d.p.savedRow.splice(0, 1)) : ($.jgrid.info_dialog(e.errcap, l[1], f.bClose, {
                                                        styleUI: d.p.styleUI
                                                    }), $(d).jqGrid("restoreCell", a, b))
                                                }
                                            }, error: function (c, g, h) {
                                                $("#lui_" + $.jgrid.jqID(d.p.id)).hide(), d.grid.hDiv.loading = false, $(d).triggerHandler("jqGridErrorCell", [c, g, h]), $.isFunction(d.p.errorCell) ? (d.p.errorCell.call(d, c, g, h), $(d).jqGrid("restoreCell", a, b)) : ($.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, {
                                                    styleUI: d.p.styleUI
                                                }), $(d).jqGrid("restoreCell", a, b))
                                            }
                                    ...
                                    "clientArray" === d.p.cellsubmit && ($(i).empty(), $(d).jqGrid("setCell", d.rows[a].id, b, h, false, false, true), $(i).addClass("dirty-cell"), $(d.rows[a]).addClass("edited"), $(d).triggerHandler("jqGridAfterSaveCell", [d.rows[a].id, k, g, a, b]), $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b), d.p.savedRow.splice(0, 1))
                            } else try {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.cellEdit === true) {
                    if (c = d.p.savedRow.length >= 1 ? 0 : null, null !== c) {
                        ...
                        $(e).empty().attr("tabindex", "-1"), $(d).jqGrid("setCell", d.rows[a].id, b, d.p.savedRow[c].v, false, false, true), $(d).triggerHandler("jqGridAfterRestoreCell", [d.rows[a].id, d.p.savedRow[c].v, a, b]), $.isFunction(d.p.afterRestoreCell) && d.p.afterRestoreCell.call(d, d.rows[a].id, d.p.savedRow[c].v, a, b), d.p.savedRow.splice(0, 1)
                    }
                    window.setTimeout(function () {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.cellEdit === true) {
                    for (c = b + 1; c < d.p.colModel.length; c++)
                        if (d.p.colModel[c].editable === true && (!$.isFunction(d.p.isCellEditable) || d.p.isCellEditable.call(d, d.p.colModel[c].name, a, c))) {
                            e = c;
                            break
                        }
                    e !== false ? $(d).jqGrid("editCell", a, e, true) : d.p.savedRow.length > 0 && $(d).jqGrid("saveCell", a, b)
                }
            })
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.cellEdit === true) {
                    ...
                    $(f).insertBefore(c.grid.cDiv), $("#" + c.p.knv).focus().keydown(function (f) {
                        ...
                        case 38:
                            c.p.iRow - 1 > 0 && (a(c.p.iRow - 1, c.p.iCol, "vu"), $(c).jqGrid("editCell", c.p.iRow - 1, c.p.iCol, false));
                            break;
                        case 40:
                            c.p.iRow + 1 <= c.rows.length - 1 && (a(c.p.iRow + 1, c.p.iCol, "vd"), $(c).jqGrid("editCell", c.p.iRow + 1, c.p.iCol, false));
                            break;
                        case 37:
                            c.p.iCol - 1 >= 0 && (d = b(c.p.iCol - 1, "lft"), a(c.p.iRow, d, "h"), $(c).jqGrid("editCell", c.p.iRow, d, false));
                            break;
                        case 39:
                            c.p.iCol + 1 <= c.p.colModel.length - 1 && (d = b(c.p.iCol + 1, "rgt"), a(c.p.iRow, d, "h"), $(c).jqGrid("editCell", c.p.iRow, d, false));
                            break;
                        case 13:
                            parseInt(c.p.iCol, 10) >= 0 && parseInt(c.p.iRow, 10) >= 0 && $(c).jqGrid("editCell", c.p.iRow, c.p.iCol, true);
                            break;
                        default:
                            return true
                        }
            ...
            return a || (a = "all"), this.each(function () {
                var c, d = this;
                d.grid && d.p.cellEdit === true && $(d.rows).each(function (e) {
                    var f = {};
        ...
        showModal: function (a) {
            ...
            var c = b.gb && "string" == typeof b.gb && "#gbox_" === b.gb.substr(0, 6) ? $("#" + b.gb.substr(6))[0] : false;
            if (b.onClose) {
            ...
            if ($.fn.jqm && b.jqm === true) $(a).attr("aria-hidden", "true").jqmHide();
            else {
                if ("" !== b.gb) try {
            ...
            c = $.extend(true, {}, $.jgrid.jqModal || {}, c);
            var h = this,
                i = "rtl" === $(c.gbox).attr("dir") ? true : false,
            ...
            $(o).addClass("ui-jqdialog-content " + j.content).attr("id", a.modalcontent), $(o).append(b), l.appendChild(o), $(l).prepend(m), f === true ? $("body").append(l) : "string" == typeof f ? $(f).append(l) : $(l).insertBefore(d), $(l).css(g), void 0 === c.jqModal && (c.jqModal = true);
            var p = {};
            if ($.fn.jqm && c.jqModal === true) {
                if (0 === c.left && 0 === c.top && c.overlay) {
                    var q = [];
                    q = $.jgrid.findPos(e), c.left = q[0] + 4, c.top = q[1] + 4
                }
                p.top = c.top + "px", p.left = c.left
            } else(0 !== c.left || 0 !== c.top) && (p.left = c.left, p.top = c.top + "px"); if ($("a.ui-jqdialog-titlebar-close", m).click(function () {
                ...
                return h.hideModal("#" + $.jgrid.jqID(a.themodal), {
                    ...
                    jqm: c.jqModal,
                    onClose: b,
                    removemodal: c.removemodal || false,
                    formprop: !c.recreateForm || false,
                    form: c.form || ""
                }), false
            ...
            if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
                ...
                "aria-hidden": "true"
            }), void 0 === c.drag && (c.drag = true), void 0 === c.resize && (c.resize = true), c.drag)
            ...
            if (c.resize)
                if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : false);
                else try {
                    $(l).resizable({
                        handles: "se, sw",
                        alsoResize: a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : false
                    })
                } catch (u) {}
            c.closeOnEscape === true && $(l).keydown(function (b) {
                if (27 === b.which) {
            ...
            if (b = $.extend({
                ...
                jqm: true,
                jqM: true
            }, b || {}), void 0 === b.focusField && (b.focusField = 0), b.focusField = "number" == typeof b.focusField && b.focusField >= 0 ? parseInt(b.focusField, 10) : "boolean" != typeof b.focusField || b.focusField ? 0 : false, $.fn.jqm && b.jqm === true) b.jqM ? $(a).attr("aria-hidden", "false").jqm(b).jqmShow() : $(a).attr("aria-hidden", "false").jqmShow();
            ...
            $.jgrid.createModal({
                ...
                scrollelm: "infocnt"
            }, n, e, "", "", true), k && $.each(e.buttons, function (a) {
                $("#" + $.jgrid.jqID(this.id), "#info_id").bind("click", function () {
                    return e.buttons[a].onClick.call($("#info_dialog")), false
                })
            ...
            case "checkbox":
                if (g = document.createElement("input"), g.type = "checkbox", b.value) {
                    var i = b.value.split(":");
                    c === i[0] && (g.checked = true, g.defaultChecked = true), g.value = i[0], $(g).attr("offval", i[1])
                } else {
                    var j = (c + "").toLowerCase();
                    j.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== j ? (g.checked = true, g.defaultChecked = true, g.value = c) : g.value = "on", $(g).attr("offval", "off")
                }
            ...
            case "select":
                ...
                var k, l = [];
                if (b.multiple === true ? (k = true, g.multiple = "multiple", $(g).attr("aria-multiselectable", "true")) : k = false, null != b.dataUrl) {
                    var m = null,
                        ...
                        success: function (a) {
                            ...
                            "string" == typeof l && (l = $($.trim(l)).html()), l && ($(d).append(l), f(d, g, n ? ["postData"] : void 0), void 0 === g.size && (g.size = i ? 3 : 1), i ? (c = e.split(","), c = $.map(c, function (a) {
                                ...
                                if ($("option", d).each(function (a) {
                                    b = $(this).text(), e = $(this).val() || b, j && (k += (0 !== a ? ";" : "") + e + ":" + b), 0 === a && d.multiple && (this.selected = false), $(this).attr("role", "option"), ($.inArray($.trim(b), c) > -1 || $.inArray($.trim(e), c) > -1) && (this.selected = "selected")
                                }), j)
                                    ...
                                    $.each(f, function () {
                                        return a = this.index || this.name, g.name === a ? (this.searchoptions.dataUrl = null, this.searchoptions.value = k, false) : void 0
                                    })
                                }
            ...
            var c, d = function (a) {
                ...
                e = {};
            if (a = a.toLowerCase(), c = -1 !== a.indexOf("/") ? "/" : -1 !== a.indexOf("-") ? "-" : -1 !== a.indexOf(".") ? "." : "/", a = a.split(c), b = b.split(c), 3 !== b.length) return false;
            var f, g, h = -1,
                i = -1,
                j = -1;
            ...
            return -1 === h ? false : (l = e[a[h]].toString(), 2 === f && 1 === l.length && (f = 1), l.length !== f || 0 === e[a[h]] && "00" !== b[h] ? false : -1 === j ? false : (l = e[a[j]].toString(), l.length < 1 || e[a[j]] < 1 || e[a[j]] > 12 ? false : -1 === i ? false : (l = e[a[i]].toString(), l.length < 1 || e[a[i]] < 1 || e[a[i]] > 31 || 2 === e[a[j]] && e[a[i]] > d(e[a[h]]) || e[a[i]] > m[e[a[j]]] ? false : true)))
        }, isEmpty: function (a) {
            return a.match(/^\s+$/) || "" === a ? true : false
        }, checkTime: function (a) {
            var b, c = /^(\d{1,2}):(\d{2})([apAP][Mm])?$/;
            if (!$.jgrid.isEmpty(a)) {
                if (b = a.match(c), !b) return false;
                if (b[3]) {
            ...
            else e = c, g = void 0 === d ? "_" : d; if (e) {
                if (g || (g = null != k.p.colNames ? k.p.colNames[b] : l[b].label), e.required === true && $.jgrid.isEmpty(a)) return [false, g + ": " + m.required, ""];
                var n = e.required === false ? false : true;
                if (e.number === true && (n !== false || !$.jgrid.isEmpty(a)) && isNaN(a)) return [false, g + ": " + m.number, ""];
                if (void 0 !== e.minValue && !isNaN(e.minValue) && parseFloat(a) < parseFloat(e.minValue)) return [false, g + ": " + m.minValue + " " + e.minValue, ""];
                if (void 0 !== e.maxValue && !isNaN(e.maxValue) && parseFloat(a) > parseFloat(e.maxValue)) return [false, g + ": " + m.maxValue + " " + e.maxValue, ""];
                var o;
                if (e.email === true && !(n === false && $.jgrid.isEmpty(a) || (o = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, o.test(a)))) return [false, g + ": " + m.email, ""];
                if (e.integer === true && (n !== false || !$.jgrid.isEmpty(a))) {
                    if (isNaN(a)) return [false, g + ": " + m.integer, ""];
                    if (a % 1 !== 0 || -1 !== a.indexOf(".")) return [false, g + ": " + m.integer, ""]
                }
                if (e.date === true && !(n === false && $.jgrid.isEmpty(a) || (l[b].formatoptions && l[b].formatoptions.newformat ? (h = l[b].formatoptions.newformat, j = $.jgrid.getRegional(k, "formatter.date.masks"), j && j.hasOwnProperty(h) && (h = j[h])) : h = l[b].datefmt || "Y-m-d", $.jgrid.checkDate(h, a)))) return [false, g + ": " + m.date + " - " + h, ""];
                if (e.time === true && !(n === false && $.jgrid.isEmpty(a) || $.jgrid.checkTime(a))) return [false, g + ": " + m.date + " - hh:mm (am/pm)", ""];
                if (e.url === true && !(n === false && $.jgrid.isEmpty(a) || (o = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, o.test(a)))) return [false, g + ": " + m.url, ""];
                if (e.custom === true && (n !== false || !$.jgrid.isEmpty(a))) {
                    if ($.isFunction(e.custom_func)) {
                        var p = e.custom_func.call(k, a, g, b);
                        return $.isArray(p) ? p : [false, m.customarray, ""]
                    }
                    return [false, m.customfcheck, ""]
                }
            }
            return [true, "", ""]
        }
        ...
        return this.each(function () {
            if (!this.filter) {
                ...
                if (this.p.initFilter = $.extend(true, {}, this.p.filter), c) {
                    for (a = 0; c > a; a++) b = this.p.columns[a], b.stype ? b.inputtype = b.stype : b.inputtype || (b.inputtype = "text"), b.sorttype ? b.searchtype = b.sorttype : b.searchtype || (b.searchtype = "string"), void 0 === b.hidden && (b.hidden = false), b.label || (b.label = b.name), b.index && (b.name = b.index), b.hasOwnProperty("searchoptions") || (b.searchoptions = {}), b.hasOwnProperty("searchrules") || (b.searchrules = {});
                    var f = function () {
                    ...
                    var j = function (a, b) {
                        ...
                        c && c.length && c[0] === false && (d.error = !c[0], d.errmsg = c[1])
                    };
                    this.onchange = function () {
                        return this.p.error = false, this.p.errmsg = "", $.isFunction(this.p.onChange) ? this.p.onChange.call(this, this.p) : false
                        ...
                        if (j.append(k), this.p.ruleButtons === true) {
                        ...
                        if (this.p.groupButton && (o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + i.button + "'/>"), o.bind("click", function () {
                            return void 0 === a.groups && (a.groups = []), a.groups.push({
                                ...
                                rules: [],
                                groups: []
                            }), e.reDraw(), e.onchange(), false
                        })), k.append(o), this.p.ruleButtons === true) {
                            ...
                            q.bind("click", function () {
                                for (void 0 === a.rules && (a.rules = []), c = 0; c < e.p.columns.length; c++) {
                                    var b = void 0 === e.p.columns[c].search ? true : e.p.columns[c].search,
                                        d = e.p.columns[c].hidden === true,
                                        f = e.p.columns[c].searchoptions.searchhidden === true;
                                    if (f && b || b && !d) {
                                        p = e.p.columns[c];
                                        break
                                    }
                        ...
                        if (null !== b) {
                            ...
                            k.append(r), r.bind("click", function () {
                                ...
                                return e.reDraw(), e.onchange(), false
                            })
                        }
                        if (void 0 !== a.groups)
                        ...
                        q.append(s), s.bind("change", function () {
                            ...
                            if (k) {
                                ...
                                var b = $.jgrid.createEl.call(n, k.inputtype, k.searchoptions, "", true, m.p.ajaxSelectOptions || {}, true);
                        ...
                        for (c = 0; c < m.p.columns.length; c++) {
                            var v = void 0 === m.p.columns[c].search ? true : m.p.columns[c].search,
                                w = m.p.columns[c].hidden === true,
                                x = m.p.columns[c].searchoptions.searchhidden === true;
                        ...
                        var z = $.jgrid.createEl.call(n, k.inputtype, k.searchoptions, a.data, true, m.p.ajaxSelectOptions || {}, true);
                        ...
                        var C = $("<td></td>");
                        if (o.append(C), this.p.ruleButtons === true) {
                            ...
                            C.append(D), D.bind("click", function () {
                                ...
                                return m.reDraw(), m.onchange(), false
                            })
                        }
                        return o
                        ...
                        this.p.filter = $.extend(true, {}, this.p.initFilter), this.reDraw(), this.onchange()
                    ...
                    }, this.reDraw(), this.p.showQuery && this.onchange(), this.filter = true
                }
            }
        })
    }, $.extend($.fn.jqFilter, {
        ...
        filterToolbar: function (a) {
            ...
            return a = $.extend({
                ...
                if (!c.p.filterToolbar) {
                    ...
                    var d, e = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                        ...
                        h = function () {
                            ...
                            $.each(c.p.colModel, function () {
                                var i = $("#gs_" + c.p.idPrefix + $.jgrid.jqID(this.name), this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv);
                            ...
                            var i = g > 0 ? true : false;
                            if (a.stringResult === true || "local" === c.p.datatype || a.searchOperators === true) {
                            ...
                            var m = "stop" === $(c).triggerHandler("jqGridToolbarBeforeSearch") ? true : false;
                        ...
                        i = function (b) {
                            var d, e = {},
                                f = 0;
                            b = "boolean" != typeof b ? true : b, $.each(c.p.colModel, function () {
                                var a, b = $("#gs_" + c.p.idPrefix + $.jgrid.jqID(this.name), this.frozen === true && c.p.frozenColumns === true ? c.grid.fhDiv : c.grid.hDiv);
                                ...
                                case "select":
                                    if (b.find("option").each(function (b) {
                                        return 0 === b && (this.selected = true), $(this).val() === a ? (this.selected = true, false) : void 0
                                    }), void 0 !== a) e[d] = a, f++;
                                    else try {
                                        delete c.p.postData[d]
                                    } catch (g) {}
                            ...
                            var g = f > 0 ? true : false;
                            if (c.p.resetsearch = true, a.stringResult === true || "local" === c.p.datatype) {
                            ...
                            var k = "stop" === $(c).triggerHandler("jqGridToolbarBeforeClear") ? true : false;
                        ...
                        j = function () {
                            var a = $("tr.ui-search-toolbar", c.grid.hDiv),
                                b = c.p.frozenColumns === true ? $("tr.ui-search-toolbar", c.grid.fhDiv) : false;
                        ...
                        k = function (b, d, g) {
                            ...
                            l += "</ul>", $("body").append(l), $("#sopt_menu").addClass("ui-menu " + e.menu_widget), $("#sopt_menu > li > a").hover(function () {
                                ...
                                var d = $(this).attr("value"),
                                    e = $(this).attr("oper");
                                if ($(c).triggerHandler("jqGridToolbarSelectOper", [d, e, b]), $("#sopt_menu").hide(), $(b).text(e).attr("soper", d), a.autosearch === true) {
                    ...
                    $.each(c.p.colModel, function (b) {
                        ...
                        if (this.hidden === true && $(s).css("display", "none"), this.search = this.search === false ? false : true, void 0 === this.stype && (this.stype = "text"), f = $.extend({}, this.searchoptions || {}, {
                            name: p.index || p.name,
                            ...
                            switch ($("td:eq(0)", u).attr("colindex", b).append(q), void 0 === f.clearSearch && (f.clearSearch = true), f.clearSearch ? (m = a.resetTitle || "Clear Search Value", $("td:eq(2)", u).append("<a title='" + m + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>")) : $("td:eq(2)", u).hide(), this.surl && (f.dataUrl = this.surl), n = "", f.defaultValue && (n = $.isFunction(f.defaultValue) ? f.defaultValue.call(c) : f.defaultValue), o = $.jgrid.createEl.call(c, this.stype, f, n, false, $.extend({}, $.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})), $(o).css({
                                width: "100%"
                            }).addClass(e.srInput), $("td:eq(1)", u).append(o), $(t).append(u), this.stype) {
                            case "select":
                                a.autosearch === true && (f.dataEvents = [{
                                    type: "change",
                                    fn: function () {
                                        return h(), false
                                    }
                                ...
                                break;
                            case "text":
                                a.autosearch === true && (f.dataEvents = a.searchOnEnter ? [{
                                    type: "keypress",
                                    fn: function (a) {
                                        var b = a.charCode || a.keyCode || 0;
                                        return 13 === b ? (h(), false) : this
                                    }
                                }] : [{
                                    type: "keydown",
                                    fn: function (b) {
                        ...
                        "select" === c.p.colModel[d].stype ? f ? $("td.ui-search-input select", b).val(f) : $("td.ui-search-input select", b)[0].selectedIndex = 0 : $("td.ui-search-input input", b).val(f), a.autosearch === true && h()
                    }), this.p.filterToolbar = true, this.triggerToolbar = h, this.clearToolbar = i, this.toggleToolbar = j
                }
            })
        }, destroyFilterToolbar: function () {
            return this.each(function () {
                this.p.filterToolbar && (this.triggerToolbar = null, this.clearToolbar = null, this.toggleToolbar = null, this.p.filterToolbar = false, $(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove())
            })
            ...
            return a = $.extend(true, {
                ...
                function b(b) {
                    f = $(c).triggerHandler("jqGridFilterBeforeShow", [b]), void 0 === f && (f = true), f && $.isFunction(a.beforeShowSearch) && (f = a.beforeShowSearch.call(c, b)), f && ($.jgrid.viewModal("#" + $.jgrid.jqID(h.themodal), {
                ...
                if (c.grid) {
                    ...
                    if (a.styleUI = c.p.styleUI, "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === true && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]) b($("#fbox_" + $.jgrid.jqID(c.p.id)));
                    else {
                        ...
                        if (a.showQuery && (t = "<a id='" + e + "_query' class='fm-button " + k.button + " fm-button-icon-left'><span class='" + k.icon_base + " " + j.icon_query + "'></span>Query</a>"), a.columns.length ? (q = a.columns, w = 0, o = q[0].index || q[0].name) : $.each(q, function (a, b) {
                            if (b.label || (b.label = c.p.colNames[a]), !v) {
                                var d = void 0 === b.search ? true : b.search,
                                    e = b.hidden === true,
                                    f = b.searchoptions && b.searchoptions.searchhidden === true;
                                (f && d || d && !e) && (v = true, o = b.index || b.name, w = a)
                            }
                        }), !i && o || a.multipleSearch === false) {
                            var x = "eq";
                        ...
                        v = false, a.tmplNames && a.tmplNames.length && (v = true, u = "<tr><td class='ui-search-label'>" + a.tmplLabel + "</td>", u += "<td><select class='ui-template " + j.srSelect + "'>", u += "<option value='default'>Default</option>", $.each(a.tmplNames, function (a, b) {
                            ...
                            var b = $(this).val();
                            return "default" === b ? $("#" + e).jqFilter("addFilter", i) : $("#" + e).jqFilter("addFilter", a.tmplFilters[parseInt(b, 10)]), false
                        }), a.multipleGroup === true && (a.multipleSearch = true), $(c).triggerHandler("jqGridFilterInitialize", [$("#" + e)]), $.isFunction(a.onInitializeSearch) && a.onInitializeSearch.call(c, $("#" + e)), a.gbox = "#gbox_" + e, a.layer ? $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "#" + $.jgrid.jqID(a.layer), {
                            position: "relative"
                            ...
                            var c = $(b.target);
                            return !a.searchOnEnter || 13 !== b.which || c.hasClass("add-group") || c.hasClass("add-rule") || c.hasClass("delete-group") || c.hasClass("delete-rule") || c.hasClass("fm-button") && c.is("[id$=_query]") ? a.closeOnEscape && 27 === b.which ? ($("#" + $.jgrid.jqID(h.modalhead)).find(".ui-jqdialog-titlebar-close").click(), false) : void 0 : ($("#" + e + "_search").click(), false)
                        }), t && $("#" + e + "_query").bind("click", function () {
                            return $(".queryresult", l).toggle(), false
                        }), void 0 === a.stringResult && (a.stringResult = a.multipleSearch), $("#" + e + "_search").bind("click", function () {
                            var b, f, i = {};
                            if (d = $("#" + e), d.find(".input-elm:focus").change(), f = d.jqFilter("filterData"), a.errorcheck && (d[0].hideError(), a.showQuery || d.jqFilter("toSQLString"), d[0].p.error)) return d[0].showError(), false;
                            if (a.stringResult) {
                                try {
                                    b = JSON.stringify(f)
                                } catch (j) {}
                            ...
                            return c.p.search = true, $.extend(c.p.postData, i), g = $(c).triggerHandler("jqGridFilterSearch"), void 0 === g && (g = true), g && $.isFunction(a.onSearch) && (g = a.onSearch.call(c, c.p.filters)), g !== false && $(c).trigger("reloadGrid", [{
                                page: 1
                            ...
                            var b = {},
                                d = $("#" + e);
                            return c.p.search = false, c.p.resetsearch = true, a.multipleSearch === false ? b[a.sField] = b[a.sValue] = b[a.sOper] = "" : b[a.sFilter] = "", d[0].resetFilter(), v && $(".ui-template", l).val("default"), $.extend(c.p.postData, b), g = $(c).triggerHandler("jqGridFilterReset"), void 0 === g && (g = true), g && $.isFunction(a.onReset) && (g = a.onReset.call(c)), g !== false && $(c).trigger("reloadGrid", [{
                                page: 1
    ...
    if ($.jgrid.extend({
        editGridRow: function (a, b) {
            ...
            return b = $.extend(true, {
                ...
                function d(a, b, c, d) {
                    ...
                    if ("_empty" !== a && (o = $(b).jqGrid("getInd", a)), $(b.p.colModel).each(function (l) {
                        if (f = this.name, g = this.editrules && this.editrules.edithidden === true ? false : this.hidden === true ? true : false, j = g ? "style='display:none'" : "", "cb" !== f && "subgrid" !== f && this.editable === true && "rn" !== f) {
                            if (o === false) i = "";
                            else if (f === b.p.ExpandColumn && b.p.treeGrid === true) i = $("td[role='gridcell']:eq(" + l + ")", b.rows[o]).text();
                            else {
                                try {
                ...
                function g(a, b, c) {
                    ...
                    if ("_empty" === a) return $(k).each(function () {
                        d = this.name, g = $.extend({}, this.editoptions || {}), f = $("#" + $.jgrid.jqID(d), c), f && f.length && null !== f[0] && (h = "", "custom" === this.edittype && $.isFunction(g.custom_value) ? g.custom_value.call(p, $("#" + d, c), "set", h) : g.defaultValue ? (h = $.isFunction(g.defaultValue) ? g.defaultValue.call(p) : g.defaultValue, "checkbox" === f[0].type ? (i = h.toLowerCase(), i.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== i ? (f[0].checked = true, f[0].defaultChecked = true, f[0].value = h) : (f[0].checked = false, f[0].defaultChecked = false)) : f.val(h)) : "checkbox" === f[0].type ? (f[0].checked = false, f[0].defaultChecked = false, h = $(f).attr("offval")) : f[0].type && "select" === f[0].type.substr(0, 6) ? f[0].selectedIndex = 0 : f.val(h), (rp_ge[p.p.id].checkOnSubmit === true || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = h))
                    }), void $("#id_g", c).val(a);
                    var l = $(b).jqGrid("getInd", a, true);
                    l && ($('td[role="gridcell"]', l).each(function (f) {
                        if (d = k[f].name, "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === true) {
                            if (d === b.p.ExpandColumn && b.p.treeGrid === true) e = $(this).text();
                            else try {
                            ...
                            switch (p.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[p.p.id].checkOnSubmit === true || rp_ge[p.p.id].checkOnUpdate) && (rp_ge[p.p.id]._savedData[d] = e), d = $.jgrid.jqID(d), k[f].edittype) {
                            case "password":
                            case "text":
                            case "button":
                            case "image":
                            ...
                            case "select":
                                ...
                                h = $.map(h, function (a) {
                                    ...
                                    this.selected = k[f].editoptions.multiple || $.trim(e) !== $.trim($(this).text()) && h[0] !== $.trim($(this).text()) && h[0] !== $.trim($(this).val()) ? k[f].editoptions.multiple && ($.inArray($.trim($(this).text()), h) > -1 || $.inArray($.trim($(this).val()), h) > -1) ? true : false : true
                                }), (rp_ge[p.p.id].checkOnSubmit === true || rp_ge[p.p.id].checkOnUpdate) && (e = $("#" + d, c).val(), k[f].editoptions.multiple && (e = e.join(",")), rp_ge[p.p.id]._savedData[d] = e);
                                break;
                            case "checkbox":
                                ...
                                } else e = e.toLowerCase(), e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e ? ($("#" + d, c)[p.p.useProp ? "prop" : "attr"]("checked", true), $("#" + d, c)[p.p.useProp ? "prop" : "attr"]("defaultChecked", true)) : ($("#" + d, c)[p.p.useProp ? "prop" : "attr"]("checked", false), $("#" + d, c)[p.p.useProp ? "prop" : "attr"]("defaultChecked", false));
                                (rp_ge[p.p.id].checkOnSubmit === true || rp_ge[p.p.id].checkOnUpdate) && (e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval"));
                                break;
                            case "custom":
                                try {
                ...
                function h() {
                    $.each(p.p.colModel, function (a, b) {
                        b.editoptions && b.editoptions.NullIfEmpty === true && r.hasOwnProperty(b.name) && "" === r[b.name] && (r[b.name] = "null")
                    })
                }

                function i() {
                    var a, c, d, e, i, j, k, l = [true, "", ""],
                        m = {},
                        n = p.p.prmNames,
                    ...
                    for (e in r)
                        if (r.hasOwnProperty(e) && (l = $.jgrid.checkValues.call(p, r[e], e), l[0] === false)) break;
                    if (h(), l[0] && (m = $(p).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[p.p.id], r, t]), void 0 === m && $.isFunction(rp_ge[p.p.id].onclickSubmit) && (m = rp_ge[p.p.id].onclickSubmit.call(p, rp_ge[p.p.id], r, t) || {}), l = $(p).triggerHandler("jqGridAddEditBeforeSubmit", [r, $(v), t]), void 0 === l && (l = [true, "", ""]), l[0] && $.isFunction(rp_ge[p.p.id].beforeSubmit) && (l = rp_ge[p.p.id].beforeSubmit.call(p, r, $(v), t))), l[0] && !rp_ge[p.p.id].processing) {
                        if (rp_ge[p.p.id].processing = true, $("#sData", x + "_2").addClass(f.active), k = rp_ge[p.p.id].url || $(p).jqGrid("getGridParam", "editurl"), d = n.oper, c = "clientArray" === k ? p.p.keyName : n.id, r[d] = "_empty" === $.trim(r[p.p.id + "_id"]) ? n.addoper : n.editoper, r[d] !== n.addoper ? r[c] = r[p.p.id + "_id"] : void 0 === r[c] && (r[c] = r[p.p.id + "_id"]), delete r[p.p.id + "_id"], r = $.extend(r, rp_ge[p.p.id].editData, m), p.p.treeGrid === true) {
                            if (r[d] === n.addoper) {
                        ...
                        var w = $.extend({
                            ...
                            complete: function (e, h) {
                                var j;
                                if ($("#sData", x + "_2").removeClass(f.active), r[c] = p.p.idPrefix + r[c], e.status >= 300 && 304 !== e.status ? (l[0] = false, l[1] = $(p).triggerHandler("jqGridAddEditErrorTextFormat", [e, t]), l[1] = $.isFunction(rp_ge[p.p.id].errorTextFormat) ? rp_ge[p.p.id].errorTextFormat.call(p, e, t) : h + " Status: '" + e.statusText + "'. Error code: " + e.status) : (l = $(p).triggerHandler("jqGridAddEditAfterSubmit", [e, r, t]), void 0 === l && (l = [true, "", ""]), l[0] && $.isFunction(rp_ge[p.p.id].afterSubmit) && (l = rp_ge[p.p.id].afterSubmit.call(p, e, r, t))), l[0] === false) $(".FormError", v).html(l[1]), $(".FormError", v).show();
                                else if (p.p.autoencode && $.each(r, function (a, b) {
                                    r[a] = $.jgrid.htmlDecode(b)
                                }), r[d] === n.addoper ? (l[2] || (l[2] = $.jgrid.randId()), null == r[c] || "_empty" === r[c] ? r[c] = l[2] : l[2] = r[c], rp_ge[p.p.id].reloadAfterSubmit ? $(p).trigger("reloadGrid") : p.p.treeGrid === true ? $(p).jqGrid("addChildNode", l[2], i, r) : $(p).jqGrid("addRowData", l[2], r, b.addedrow), rp_ge[p.p.id].closeAfterAdd ? (p.p.treeGrid !== true && $(p).jqGrid("setSelection", l[2]), $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                ...
                                }, 1e3)) : p.p.treeGrid === true ? $(p).jqGrid("setTreeRow", r[c], r) : $(p).jqGrid("setRowData", r[c], r), rp_ge[p.p.id].closeAfterEdit && $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + $.jgrid.jqID(u),
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                                ...
                                }, 500)), (rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) && ($(v).data("disabled", false), "_empty" !== rp_ge[p.p.id]._savedData[p.p.id + "_id"]))
                                    for (j in rp_ge[p.p.id]._savedData) rp_ge[p.p.id]._savedData.hasOwnProperty(j) && r[j] && (rp_ge[p.p.id]._savedData[j] = r[j]);
                                rp_ge[p.p.id].processing = false;
                                try {
                                    $(":input:visible", v)[0].focus()
                                } catch (k) {}
                            }
                        }, $.jgrid.ajaxOptions, rp_ge[p.p.id].ajaxEditOptions);
                        if (w.url || rp_ge[p.p.id].useDataProxy || ($.isFunction(p.p.dataProxy) ? rp_ge[p.p.id].useDataProxy = true : (l[0] = false, l[1] += " " + D.nourl)), l[0])
                            if (rp_ge[p.p.id].useDataProxy) {
                                var z = p.p.dataProxy.call(p, w, "set_" + p.p.id);
                                void 0 === z && (z = [true, ""]), z[0] === false ? (l[0] = false, l[1] = z[1] || "Error deleting the selected row!") : (w.data.oper === n.addoper && rp_ge[p.p.id].closeAfterAdd && $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + $.jgrid.jqID(u),
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                            ...
                            } else "clientArray" === w.url ? (rp_ge[p.p.id].reloadAfterSubmit = false, r = w.data, w.complete({
                                status: 200,
                                statusText: ""
                            }, "")) : $.ajax(w)
                    }
                    l[0] === false && ($(".FormError", v).html(l[1]), $(".FormError", v).show())
                }
                ...
                function k() {
                    var a = true;
                    return $(".FormError", v).hide(), rp_ge[p.p.id].checkOnUpdate && (r = {}, c(), s = j(r, rp_ge[p.p.id]._savedData), s && ($(v).data("disabled", true), $(".confirm", "#" + y.themodal).show(), a = false)), a
                }
                ...
                if (p.grid && a) {
                    ...
                    rp_ge[p.p.id].styleUI = p.p.styleUI || "jQueryUI", $.jgrid.isMobile() && (rp_ge[p.p.id].resize = false), "new" === a ? (a = "_empty", t = "add", b.caption = rp_ge[p.p.id].addCaption) : (b.caption = rp_ge[p.p.id].editCaption, t = "edit"), b.recreateForm || $(p).data("formProp") && $.extend(rp_ge[$(this)[0].p.id], $(p).data("formProp"));
                    var E = true;
                    b.checkOnUpdate && b.jqModal && !b.modal && (E = false);
                    var F, G = isNaN(rp_ge[$(this)[0].p.id].dataheight) ? rp_ge[$(this)[0].p.id].dataheight : rp_ge[$(this)[0].p.id].dataheight + "px",
                        ...
                        I = $("<form name='FormPost' id='" + v + "' class='FormGrid' onSubmit='return false;' style='width:" + H + ";height:" + G + ";'></form>").data("disabled", false);
                    if (C ? (F = o(rp_ge[$(this)[0].p.id].template), q = x) : (F = $("<table id='" + w + "' class='EditTable ui-common-table'><tbody></tbody></table>"), q = x + "_2"), v = "#" + $.jgrid.jqID(v), $(I).append("<div class='FormError " + f.error + "' style='display:none;'></div>"), $(I).append("<div class='tinfo topinfo'>" + rp_ge[p.p.id].topinfo + "</div>"), $(p.p.colModel).each(function () {
                    ...
                    }), $(I).append(F), z = $(p).triggerHandler("jqGridAddEditBeforeInitData", [I, t]), void 0 === z && (z = true), z && $.isFunction(rp_ge[p.p.id].beforeInitData) && (z = rp_ge[p.p.id].beforeInitData.call(p, I, t)), z !== false) {
                        l(), d(a, p, F, A);
                        var J = "rtl" === p.p.direction ? true : false,
                            K = J ? "nData" : "pData",
                            L = J ? "pData" : "nData",
                        ...
                        var S = false;
                        b.closeOnEscape === true && (b.closeOnEscape = false, S = true);
                        var T;
                        if (C ? ($(I).find("#pData").replaceWith(M), $(I).find("#nData").replaceWith(N), $(I).find("#sData").replaceWith(O), $(I).find("#cData").replaceWith(P), T = $("<div id=" + w + "></div>").append(I)) : T = $("<div></div>").append(I).append(Q), $(I).append("<div class='binfo topinfo bottominfo'>" + rp_ge[p.p.id].bottominfo + "</div>"), $.jgrid.createModal(y, T, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(p.p.id), $("#gbox_" + $.jgrid.jqID(p.p.id))[0]), J && ($("#pData, #nData", x + "_2").css("float", "right"), $(".EditButton", x + "_2").css("text-align", "left")), rp_ge[p.p.id].topinfo && $(".tinfo", v).show(), rp_ge[p.p.id].bottominfo && $(".binfo", v).show(), T = null, Q = null, $("#" + $.jgrid.jqID(y.themodal)).keydown(function (a) {
                            var c = a.target;
                            if ($(v).data("disabled") === true) return false;
                            if (rp_ge[p.p.id].savekey[0] === true && a.which === rp_ge[p.p.id].savekey[1] && "TEXTAREA" !== c.tagName) return $("#sData", x + "_2").trigger("click"), false;
                            ...
                            if (rp_ge[p.p.id].navkeys[0] === true) {
                                if ("_empty" === $("#id_g", x).val()) return true;
                                if (a.which === rp_ge[p.p.id].navkeys[1]) return $("#pData", q).trigger("click"), false;
                                if (a.which === rp_ge[p.p.id].navkeys[2]) return $("#nData", q).trigger("click"), false
                            }
                        ...
                        })), b.saveicon = $.extend([true, "left", e.icon_save], b.saveicon), b.closeicon = $.extend([true, "left", e.icon_close], b.closeicon), b.saveicon[0] === true && $("#sData", q).addClass("right" === b.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.saveicon[2] + "'></span>"), b.closeicon[0] === true && $("#cData", q).addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.closeicon[2] + "'></span>"), rp_ge[p.p.id].checkOnSubmit || rp_ge[p.p.id].checkOnUpdate) {
                            ...
                            U++, $("<div class='" + b.overlayClass + " jqgrid-overlay confirm' style='z-index:" + U + ";display:none;'>&#160;</div><div class='confirm ui-jqconfirm " + f.content + "' style='z-index:" + (U + 1) + "'>" + b.saveData + "<br/><br/>" + O + N + P + "</div>").insertAfter(v), $("#sNew", "#" + $.jgrid.jqID(y.themodal)).click(function () {
                                return i(), $(v).data("disabled", false), $(".confirm", "#" + $.jgrid.jqID(y.themodal)).hide(), false
                            }), $("#nNew", "#" + $.jgrid.jqID(y.themodal)).click(function () {
                                return $(".confirm", "#" + $.jgrid.jqID(y.themodal)).hide(), $(v).data("disabled", false), setTimeout(function () {
                                    $(":input:visible", v)[0].focus()
                                }, 0), false
                            }), $("#cNew", "#" + $.jgrid.jqID(y.themodal)).click(function () {
                                return $(".confirm", "#" + $.jgrid.jqID(y.themodal)).hide(), $(v).data("disabled", false), $.jgrid.hideModal("#" + $.jgrid.jqID(y.themodal), {
                                    gb: "#gbox_" + $.jgrid.jqID(u),
                                    jqm: b.jqModal,
                                    onClose: rp_ge[p.p.id].onClose,
                                    removemodal: rp_ge[p.p.id].removemodal,
                        ...
                        $(p).triggerHandler("jqGridAddEditInitializeForm", [$(v), t]), $.isFunction(rp_ge[p.p.id].onInitializeForm) && rp_ge[p.p.id].onInitializeForm.call(p, $(v), t), "_empty" !== a && rp_ge[p.p.id].viewPagerButtons ? $("#pData,#nData", q).show() : $("#pData,#nData", q).hide(), $(p).triggerHandler("jqGridAddEditBeforeShowForm", [$(v), t]), $.isFunction(rp_ge[p.p.id].beforeShowForm) && rp_ge[p.p.id].beforeShowForm.call(p, $(v), t), $("#" + $.jgrid.jqID(y.themodal)).data("onClose", rp_ge[p.p.id].onClose), $.jgrid.viewModal("#" + $.jgrid.jqID(y.themodal), {
                            ...
                            return r = {}, $(".FormError", v).hide(), c(), "_empty" === r[p.p.id + "_id"] ? i() : b.checkOnSubmit === true ? (s = j(r, rp_ge[p.p.id]._savedData), s ? ($(v).data("disabled", true), $(".confirm", "#" + $.jgrid.jqID(y.themodal)).show()) : i()) : i(), false
                            ...
                            if (a[0] = parseInt(a[0], 10), -1 !== a[0] && a[1][a[0] + 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(p, "next", $(v), a[1][a[0]]), void 0 !== c && c === false)) return false;
                                if ($("#" + $.jgrid.jqID(a[1][a[0] + 1])).hasClass(f.disabled)) return false;
                            ...
                            if (-1 !== a[0] && a[1][a[0] - 1]) {
                                ...
                                var c;
                                if ($.isFunction(b.onclickPgButtons) && (c = b.onclickPgButtons.call(p, "prev", $(v), a[1][a[0]]), void 0 !== c && c === false)) return false;
                                if ($("#" + $.jgrid.jqID(a[1][a[0] - 1])).hasClass(f.disabled)) return false;
            ...
            return b = $.extend(true, {
                ...
                function c() {
                    (rp_ge[j.p.id].closeOnEscape === true || rp_ge[j.p.id].navkeys[0] === true) && setTimeout(function () {
                ...
                function d(a, c, d, e) {
                    ...
                    if ($(c.p.colModel).each(function () {
                        h = this.editrules && this.editrules.edithidden === true ? false : this.hidden === true ? true : false, h || "right" !== this.align || (this.formatter && -1 !== $.inArray(this.formatter, v) ? w = Math.max(w, parseInt(this.width, 10)) : x = Math.max(x, parseInt(this.width, 10)))
                    }), m = 0 !== w ? w : 0 !== x ? x : 0, r = $(c).jqGrid("getInd", a), $(c.p.colModel).each(function (a) {
                        if (g = this.name, n = false, h = this.editrules && this.editrules.edithidden === true ? false : this.hidden === true ? true : false, k = h ? "style='display:none'" : "", o = "boolean" != typeof this.viewable ? true : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                            j = r === false ? "" : g === c.p.ExpandColumn && c.p.treeGrid === true ? $("td:eq(" + a + ")", c.rows[r]).text() : $("td:eq(" + a + ")", c.rows[r]).html(), n = "right" === this.align && 0 !== m ? true : false;
                            var b = $.extend({}, {
                                    rowabove: false,
                                    rowcontent: ""
                                }, this.formoptions || {}),
                ...
                function g(a, b) {
                    var c, d, e, f, g = 0;
                    f = $(b).jqGrid("getInd", a, true), f && ($("td", f).each(function (a) {
                        c = b.p.colModel[a].name, d = b.p.colModel[a].editrules && b.p.colModel[a].editrules.edithidden === true ? false : b.p.colModel[a].hidden === true ? true : false, "cb" !== c && "subgrid" !== c && "rn" !== c && (e = c === b.p.ExpandColumn && b.p.treeGrid === true ? $(this).text() : $(this).html(), c = $.jgrid.jqID("v_" + c), $("#" + c + " span", "#" + m).html(e), d && $("#" + c, "#" + m).parents("tr:first").hide(), g++)
                    }), g > 0 && $("#id_g", "#" + m).val(a))
                }
                ...
                if (j.grid && a) {
                    var k = j.p.id,
                        ...
                        q = $.isFunction(rp_ge[j.p.id].beforeInitData) ? rp_ge[j.p.id].beforeInitData : false,
                        r = true,
                        s = 1,
                        t = 0;
                    ...
                    if ($(j.p.colModel).each(function () {
                    ...
                    }), $(w).append(x), q && (r = q.call(j, w), void 0 === r && (r = true)), r !== false) {
                        d(a, j, x, s);
                        var y = "rtl" === j.p.direction ? true : false,
                            z = y ? "nData" : "pData",
                            A = y ? "pData" : "nData",
                        ...
                        $.jgrid.createModal(p, F, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(j.p.id), $("#gview_" + $.jgrid.jqID(j.p.id))[0]), y && ($("#pData, #nData", "#" + m + "_2").css("float", "right"), $(".EditButton", "#" + m + "_2").css("text-align", "left")), b.viewPagerButtons || $("#pData, #nData", "#" + m + "_2").hide(), F = null, $("#" + p.themodal).keydown(function (a) {
                            ...
                            if (b.navkeys[0] === true) {
                                if (a.which === b.navkeys[1]) return $("#pData", "#" + m + "_2").trigger("click"), false;
                                if (a.which === b.navkeys[2]) return $("#nData", "#" + m + "_2").trigger("click"), false
                            }
                        }), b.closeicon = $.extend([true, "left", e.icon_close], b.closeicon), b.closeicon[0] === true && $("#cData", "#" + m + "_2").addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.closeicon[2] + "'></span>"), $.isFunction(b.beforeShowForm) && b.beforeShowForm.call(j, $("#" + l)), $.jgrid.viewModal("#" + $.jgrid.jqID(p.themodal), {
                            ...
                            $("#FormError", "#" + m).hide();
                            var a = i();
                            return a[0] = parseInt(a[0], 10), -1 !== a[0] && a[1][a[0] + 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(j, "next", $("#" + l), a[1][a[0]]), g(a[1][a[0] + 1], j), $(j).jqGrid("setSelection", a[1][a[0] + 1]), $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(j, "next", $("#" + l), a[1][a[0] + 1]), h(a[0] + 1, a)), c(), false
                        }), $("#pData", "#" + m + "_2").click(function () {
                            $("#FormError", "#" + m).hide();
                            var a = i();
                            return -1 !== a[0] && a[1][a[0] - 1] && ($.isFunction(b.onclickPgButtons) && b.onclickPgButtons.call(j, "prev", $("#" + l), a[1][a[0]]), g(a[1][a[0] - 1], j), $(j).jqGrid("setSelection", a[1][a[0] - 1]), $.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons.call(j, "prev", $("#" + l), a[1][a[0] - 1]), h(a[0] - 1, a)), c(), false
                        });
                        var G = i();
                        h(G[0], G)
                    }
            ...
            return b = $.extend(true, {
                ...
                if (c.grid && a) {
                    var d, g, h, i, j = $.isFunction(rp_ge[c.p.id].beforeShowForm),
                        ...
                        l = $.isFunction(rp_ge[c.p.id].beforeInitData) ? rp_ge[c.p.id].beforeInitData : false,
                        m = c.p.id,
                        n = {},
                        o = true,
                    ...
                    if (rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI", $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(r.themodal))[0]) {
                        if (l && (o = l.call(c, $("#" + p)), void 0 === o && (o = true)), o === false) return;
                        $("#DelData>td", "#" + p).text(a), $("#DelError", "#" + p).hide(), rp_ge[c.p.id].processing === true && (rp_ge[c.p.id].processing = false, $("#dData", "#" + p).removeClass(f.active)), j && rp_ge[c.p.id].beforeShowForm.call(c, $("#" + p)), $.jgrid.viewModal("#" + $.jgrid.jqID(r.themodal), {
                        ...
                        if (u += "<table class='EditTable ui-common-table' id='" + p + "_2'><tbody><tr><td><hr class='" + f.content + "' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + v + "&#160;" + w + "</td></tr></tbody></table>", b.gbox = "#gbox_" + $.jgrid.jqID(m), $.jgrid.createModal(r, u, rp_ge[c.p.id], "#gview_" + $.jgrid.jqID(c.p.id), $("#gview_" + $.jgrid.jqID(c.p.id))[0]), l && (o = l.call(c, $(u)), void 0 === o && (o = true)), o === false) return;
                        $(".fm-button", "#" + p + "_2").hover(function () {
                            $(this).addClass(f.hover)
                        }, function () {
                            $(this).removeClass(f.hover)
                        }), b.delicon = $.extend([true, "left", e.icon_del], rp_ge[c.p.id].delicon), b.cancelicon = $.extend([true, "left", e.icon_cancel], rp_ge[c.p.id].cancelicon), b.delicon[0] === true && $("#dData", "#" + p + "_2").addClass("right" === b.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.delicon[2] + "'></span>"), b.cancelicon[0] === true && $("#eData", "#" + p + "_2").addClass("right" === b.cancelicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='" + f.icon_base + " " + b.cancelicon[2] + "'></span>"), $("#dData", "#" + p + "_2").click(function () {
                            var a, e = [true, ""],
                                j = $("#DelData>td", "#" + p).text();
                            if (n = {}, $.isFunction(rp_ge[c.p.id].onclickSubmit) && (n = rp_ge[c.p.id].onclickSubmit.call(c, rp_ge[c.p.id], j) || {}), $.isFunction(rp_ge[c.p.id].beforeSubmit) && (e = rp_ge[c.p.id].beforeSubmit.call(c, j)), e[0] && !rp_ge[c.p.id].processing) {
                                if (rp_ge[c.p.id].processing = true, h = c.p.prmNames, d = $.extend({}, rp_ge[c.p.id].delData, n), i = h.oper, d[i] = h.deloper, g = h.id, j = String(j).split(","), !j.length) return false;
                                ...
                                var k = $.extend({
                                    ...
                                    complete: function (a, g) {
                                        var h;
                                        if ($("#dData", "#" + p + "_2").removeClass(f.active), a.status >= 300 && 304 !== a.status ? (e[0] = false, e[1] = $.isFunction(rp_ge[c.p.id].errorTextFormat) ? rp_ge[c.p.id].errorTextFormat.call(c, a) : g + " Status: '" + a.statusText + "'. Error code: " + a.status) : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)), e[0] === false) $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show();
                                        else {
                                        ...
                                        rp_ge[c.p.id].processing = false, e[0] && $.jgrid.hideModal("#" + $.jgrid.jqID(r.themodal), {
                                ...
                                if (k.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? rp_ge[c.p.id].useDataProxy = true : (e[0] = false, e[1] += " " + $.jgrid.getRegional(c, "errors.nourl"))), e[0])
                                    if (rp_ge[c.p.id].useDataProxy) {
                                        var l = c.p.dataProxy.call(c, k, "del_" + c.p.id);
                                        void 0 === l && (l = [true, ""]), l[0] === false ? (e[0] = false, e[1] = l[1] || "Error deleting the selected row!") : $.jgrid.hideModal("#" + $.jgrid.jqID(r.themodal), {
                                            gb: "#gbox_" + $.jgrid.jqID(m),
                                            jqm: b.jqModal,
                                            onClose: rp_ge[c.p.id].onClose
                                        })
                            ...
                            return e[0] === false && ($("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show()), false
                    ...
                    rp_ge[c.p.id].closeOnEscape === true && setTimeout(function () {
                ...
                if (!this.p.navGrid) {
                    ...
                    if (o.grid && "string" == typeof a) {
                        $(o).data("navGrid") || $(o).data("navGrid", b), m = $(o).data("navGrid"), o.p.force_regional && (m = $.extend(m, h)), void 0 === $("#" + n.themodal)[0] && (m.alerttop || m.alertleft || (void 0 !== window.innerWidth ? (m.alertleft = window.innerWidth, m.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (m.alertleft = document.documentElement.clientWidth, m.alerttop = document.documentElement.clientHeight) : (m.alertleft = 1024, m.alerttop = 768), m.alertleft = m.alertleft / 2 - parseInt(m.alertwidth, 10) / 2, m.alerttop = m.alerttop / 2 - 25), $.jgrid.createModal(n, "<div>" + m.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                            ...
                            styleUI: o.p.styleUI
                        }, "#gview_" + $.jgrid.jqID(o.p.id), $("#gbox_" + $.jgrid.jqID(o.p.id))[0], true));
                        var p, q = 1,
                            r = function () {
                        ...
                        for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; q > p; p++) {
                            ...
                            0 === p ? (u = a, v = o.p.id, u === o.p.toppager && (v += "_top", q = 1)) : (u = o.p.toppager, v = o.p.id + "_top"), "rtl" === o.p.direction && $(w).attr("dir", "rtl").css("float", "right"), d = d || {}, m.add && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"), $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.addicon + "'></span>" + m.addtext + "</div>"), $("tr", w).append(t), $(t, w).attr({
                                ...
                                return $(this).hasClass(k.disabled) || ($.isFunction(m.addfunc) ? m.addfunc.call(o) : $(o).jqGrid("editGridRow", "new", d)), false
                                ...
                                return $(this).hasClass(k.disabled) || ($.isFunction(m.searchfunc) ? m.searchfunc.call(o, f) : $(o).jqGrid("searchGrid", f)), false
                            }).hover(r, s), f.showOnLoad && f.showOnLoad === true && $(t, w).click(), t = null), m.refresh && (t = $("<td class='ui-pg-button " + k.cornerall + "'></td>"), $(t).append("<div class='ui-pg-div'><span class='" + k.icon_base + " " + m.refreshicon + "'></span>" + m.refreshtext + "</div>"), $("tr", w).append(t), $(t, w).attr({
                                title: m.refreshtitle || "",
                                id: "refresh_" + v
                            }).click(function () {
                                if (!$(this).hasClass(k.disabled)) {
                                    $.isFunction(m.beforeRefresh) && m.beforeRefresh.call(o), o.p.search = false, o.p.resetsearch = true;
                                    try {
                                        if ("currentfilter" !== m.refreshstate) {
                                            ...
                                            $.isFunction(o.clearToolbar) && o.clearToolbar.call(o, false)
                                        }
                                    } catch (c) {}
                ...
                if (this.grid) {
                    ...
                    if (d) {
                        ...
                        $(j).addClass("ui-pg-button " + h).append("NONE" === b.buttonicon.toString().toUpperCase() ? "<div class='ui-pg-div'>" + b.caption + "</div>" : "<div class='ui-pg-div'><span class='" + i + " " + b.buttonicon + "'></span>" + b.caption + "</div>"), b.id && $(j).attr("id", b.id), "first" === b.position ? 0 === d.rows[0].cells.length ? $("tr", d).append(j) : $("tr td:eq(0)", d).before(j) : $("tr", d).append(j), $(j, d).attr("title", b.title || "").click(function (a) {
                            return $(this).hasClass(f) || $.isFunction(b.onClickButton) && b.onClickButton.call(e, a), false
                        }).hover(function () {
                        ...
                        k && ("first" === b.position ? $("#" + k).prepend(m) : $("#" + k).append(m), $(m).on("click", function (a) {
                            return $(this).hasClass(f) || ($("#" + k).hide(), $.isFunction(b.onClickButton) && b.onClickButton.call(e, a)), false
                ...
                var o = {
                    ...
                    p = function () {
                        ...
                        c.add && (e = e || {}, a = e.id || "add_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.addtext || c.addtitle) + "</a></li>").click(function () {
                            return $(this).hasClass(l.disabled) || ($.isFunction(c.addfunc) ? c.addfunc.call(i) : $(i).jqGrid("editGridRow", "new", e), $(p).hide()), false
                            ...
                            return $(this).hasClass(l.disabled) || ($.isFunction(c.searchfunc) ? c.searchfunc.call(i, g) : $(i).jqGrid("searchGrid", g), $(p).hide()), false
                        }), $(p).append(j), g.showOnLoad && g.showOnLoad === true && $(j).click()), c.refresh && (a = g.id || "search_" + b, j = $('<li class="ui-menu-item" role="presentation"><a class="' + l.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.refreshtext || c.refreshtitle) + "</a></li>").click(function () {
                            if (!$(this).hasClass(l.disabled)) {
                                $.isFunction(c.beforeRefresh) && c.beforeRefresh.call(i), i.p.search = false, i.p.resetsearch = true;
                                try {
                                    if ("currentfilter" !== c.refreshstate) {
                                        ...
                                        $.isFunction(i.clearToolbar) && i.clearToolbar.call(i, false)
                                    }
                                } catch (d) {}
                ...
                if (d.grid) {
                    ...
                    if (e)
                        for (c in e) e.hasOwnProperty(c) && ($("[name=" + $.jgrid.jqID(c) + "]", b).is("input:radio") || $("[name=" + $.jgrid.jqID(c) + "]", b).is("input:checkbox") ? $("[name=" + $.jgrid.jqID(c) + "]", b).each(function () {
                            $(this).val() == e[c] ? $(this)[d.p.useProp ? "prop" : "attr"]("checked", true) : $(this)[d.p.useProp ? "prop" : "attr"]("checked", false)
        ...
        groupingSetup: function () {
            return this.each(function () {
                ...
                if (null === f || "object" != typeof f && !$.isFunction(f)) d.p.grouping = false;
                else if (f.plusicon || (f.plusicon = g.icon_plus), f.minusicon || (f.minusicon = g.icon_minus), f.groupField.length) {
                    for (void 0 === f.visibiltyOnNextGrouping && (f.visibiltyOnNextGrouping = []), f.lastvalues = [], f._locgr || (f.groups = []), f.counters = [], a = 0; a < f.groupField.length; a++) f.groupOrder[a] || (f.groupOrder[a] = "asc"), f.groupText[a] || (f.groupText[a] = "{0}"), "boolean" != typeof f.groupColumnShow[a] && (f.groupColumnShow[a] = true), "boolean" != typeof f.groupSummary[a] && (f.groupSummary[a] = false), f.groupSummaryPos[a] || (f.groupSummaryPos[a] = "footer"), f.groupColumnShow[a] === true ? (f.visibiltyOnNextGrouping[a] = true, $(d).jqGrid("showCol", f.groupField[a])) : (f.visibiltyOnNextGrouping[a] = $("#" + $.jgrid.jqID(d.p.id + "_" + f.groupField[a])).is(":visible"), $(d).jqGrid("hideCol", f.groupField[a]));
            ...
            return this.each(function () {
                ...
                var f, g, h = d.join("_"),
                    ...
                    o = false,
                    p = false,
                    q = b.p.frozenColumns ? b.p.id + "_frozen" : false,
                    r = q ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(q)) : false,
                ...
                if (m.hasClass(i)) {
                    if (c.showSummaryOnHide) {
                        ...
                        for (; l && (f = n(l.className), !(void 0 !== f && e >= f));) $(l).hide(), l = l.nextSibling, q && ($(s).hide(), s = s.nextSibling);
                    m.removeClass(i).addClass(j), o = true
                } else {
                    if (l)
                        for (g = void 0; l;) {
            ...
            return this.each(function () {
                    ...
                    for (h = f; b > h; h++) {
                        ...
                        $.each(i.summary, function () {
                            if (this.nm === k[h].name) {
                                ...
                                return n = "<td " + j.formatCol(h, 1, "") + ">" + $.jgrid.template(o, g) + "</td>", false
                            }
                        }), m += n
                    }
                    return m
                ...
                t.reverse(), r = j.p.multiselect ? ' colspan="2"' : "", $.each(k.groups, function (e, u) {
                    if (k._locgr && !(u.startRow + u.cnt > (c - 1) * d && u.startRow < c * d)) return true;
            ...
            return this.each(function () {
                ...
                c.p.grouping = true, d._locgr = false, void 0 === d.visibiltyOnNextGrouping && (d.visibiltyOnNextGrouping = []);
                var e;
            ...
            return this.each(function () {
                var b = this;
                if (void 0 === a && (a = true), b.p.grouping = false, a === true) {
            ...
            return void 0 === a && (a = true), this.each(function () {
                ...
                if (j) {
                    ...
                    $(k).children("tr.ui-jqgrid-labels").remove(), $(k).prepend(b), a === true && $(i).jqGrid("setGridParam", {
                        groupHeader: null
                    })
                }
            })
        ...
        saveState: function (a, b) {
            ...
            if (c = $.extend({
                ...
                if (b) {
                    ...
                    if (d = jqGridUtils.parse(b), d && "object" === $.type(d)) {
                        ...
                        d.shrinkToFit = false, d.data = [], d.datatype = "local", d.grouping = false, d.navGrid = false, d.inlineNav && (g = k(d._iN), d._iN = null, delete d._iN), d.filterToolbar && (h = k(d._fT), d._fT = null, delete d._fT);
                        var m = $("#" + a).jqGrid(d);
                        m.append(f), m.jqGrid("setGridParam", l), d.storeNavOptions && m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.inlineNav && g && (m.jqGrid("setGridParam", {
                            ...
                            filterToolbar: false
                        }), m.jqGrid("filterToolbar", h)), m[0].updatepager(true, true), c.clearAfterLoad && (window[c.storageType].removeItem("jqGrid" + i.id), window[c.storageType].removeItem("jqGrid" + i.id + "_data"))
            ...
            $.jgrid.saveState(a, {
                ...
                beforeSetGrid: function (a) {
                    return a.regional = b.regional, a.force_regional = true, a
                }
            });
            var c = $("#" + a)[0],
            ...
            $.each(d, function (a) {
                return this.formatter && "actions" === this.formatter ? (e = a, false) : void 0
        ...
        jqGridExport: function (a) {
            ...
            return this.each(function () {
                if (this.grid) {
                    var c, d = $.extend(true, {}, $(this).jqGrid("getGridParam"), a.addOptions);
        ...
        editRow: function (a, b, c, d, e, f, g, h, i) {
            ...
            return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b), $.isFunction(c) && (j.oneditfunc = c), $.isFunction(d) && (j.successfunc = d), void 0 !== e && (j.url = e), void 0 !== f && (j.extraparam = f), $.isFunction(g) && (j.aftersavefunc = g), $.isFunction(h) && (j.errorfunc = h), $.isFunction(i) && (j.afterrestorefunc = i)), j = $.extend(true, {
                keys: false,
                oneditfunc: null,
                successfunc: null,
                url: null,
                ...
                var b, c, d, e, f, g, h = this,
                    ...
                    k = null,
                    l = {},
                    m = $(this).jqGrid("getStyleUI", h.p.styleUI + ".inlinedit", "inputClass", true);
                h.grid && (e = $(h).jqGrid("getInd", a, true), e !== false && (g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0, void 0 === g && (g = true), g && (d = $(e).attr("editable") || "0", "0" !== d || $(e).hasClass("not-editable-row") || (f = h.p.colModel, $('td[role="gridcell"]', e).each(function (d) {
                    b = f[d].name;
                    var e = h.p.treeGrid === true && b === h.p.ExpandColumn;
                    ...
                    if ("cb" !== b && "subgrid" !== b && "rn" !== b && (h.p.autoencode && (c = $.jgrid.htmlDecode(c)), l[b] = c, f[d].editable === true)) {
                        ...
                        var n = $.jgrid.createEl.call(h, f[d].edittype, j, c, true, $.extend({}, $.jgrid.ajaxOptions, h.p.ajaxSelectOptions || {}));
                        $(n).addClass("editable inline-edit-cell"), $.inArray(f[d].edittype, ["text", "textarea", "password", "select"]) > -1 && $(n).addClass(m), e ? $("span:first", this).append(n) : $(this).append(n), $.jgrid.bindEv.call(h, n, j), "select" === f[d].edittype && void 0 !== f[d].editoptions && f[d].editoptions.multiple === true && void 0 === f[d].editoptions.dataUrl && $.jgrid.msie && $(n).width($(n).width()), i++
                    }
                    ...
                    a.length > 0 && a.focus()
                }, 0)), j.keys === true && $(e).bind("keyup", function (b) {
                    if (27 === b.keyCode) {
                    ...
                    if (13 === b.keyCode) {
                        var d = b.target;
                        if ("TEXTAREA" === d.tagName) return true;
            ...
            var h = $.makeArray(arguments).slice(1),
                i = {},
                j = this[0];
            "object" === $.type(h[0]) ? i = h[0] : ($.isFunction(b) && (i.successfunc = b), void 0 !== c && (i.url = c), void 0 !== d && (i.extraparam = d), $.isFunction(e) && (i.aftersavefunc = e), $.isFunction(f) && (i.errorfunc = f), $.isFunction(g) && (i.afterrestorefunc = g)), i = $.extend(true, {
                successfunc: null,
                url: null,
                extraparam: {},
                aftersavefunc: null,
            ...
            var k, l, m, n, o, p = false,
                q = {},
                r = {},
                s = {},
                t = false,
                u = $.trim($(j).jqGrid("getStyleUI", j.p.styleUI + ".common", "error", true));
            if (!j.grid) return p;
            if (o = $(j).jqGrid("getInd", a, true), o === false) return p;
            ...
            if (void 0 === x && (x = true), x) {
                if (l = $(o).attr("editable"), i.url = i.url || j.p.editurl, "1" === l) {
                    var y;
                    if ($('td[role="gridcell"]', o).each(function (a) {
                        if (y = j.p.colModel[a], k = y.name, "cb" !== k && "subgrid" !== k && y.editable === true && "rn" !== k && !$(this).hasClass("not-editable-cell")) {
                            switch (y.edittype) {
                            case "checkbox":
                                var b = ["Yes", "No"];
                            ...
                            if (n = $.jgrid.checkValues.call(j, q[k], a), n[0] === false) return false;
                            j.p.autoencode && (q[k] = $.jgrid.htmlEncode(q[k])), "clientArray" !== i.url && y.editoptions && y.editoptions.NullIfEmpty === true && "" === q[k] && (s[k] = "null", t = true)
                        }
                    }), n[0] === false) {
                        try {
                    ...
                    var C, D = j.p.prmNames,
                        E = a;
                    if (C = j.p.keyName === false ? D.id : j.p.keyName, q) {
                    ...
                    if ("clientArray" === i.url) {
                        ...
                        m >= 0 && j.p.savedRow.splice(m, 1), $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, J, q, i]), $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, J, q, i), p = true, $(o).removeClass("jqgrid-new-row").unbind("keydown")
                        ...
                        complete: function (b, c) {
                            if ($(j).jqGrid("progressBar", {
                                ...
                                var d, e, f = true;
                                if (d = $(j).triggerHandler("jqGridInlineSuccessSaveRow", [b, a, i]), $.isArray(d) || (d = [true, s]), d[0] && $.isFunction(i.successfunc) && (d = i.successfunc.call(j, b)), $.isArray(d) ? (f = d[0], q = d[1] || q) : f = d, f === true) {
                                    ...
                                    m >= 0 && j.p.savedRow.splice(m, 1), $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, b, q, i]), $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, b, q, i), p = true, $(o).removeClass("jqgrid-new-row").unbind("keydown")
                                } else $(j).triggerHandler("jqGridInlineErrorSaveRow", [a, b, c, null, i]), $.isFunction(i.errorfunc) && i.errorfunc.call(j, a, b, c, null), i.restoreAfterError === true && $(j).jqGrid("restoreRow", a, i.afterrestorefunc)
                            }
                            ...
                            i.restoreAfterError === true && $(j).jqGrid("restoreRow", a, i.afterrestorefunc)
                        }
            ...
            var c = $.makeArray(arguments).slice(1),
                d = {};
            return "object" === $.type(c[0]) ? d = c[0] : $.isFunction(b) && (d.afterrestorefunc = b), d = $.extend(true, {}, $.jgrid.inlineEdit, d), this.each(function () {
                var b, c, e = this,
                    f = -1,
                    g = {};
                if (e.grid && (b = $(e).jqGrid("getInd", a, true), b !== false)) {
                    var h = $.isFunction(d.beforeCancelRow) ? d.beforeCancelRow.call(e, d, a) : void 0;
                    if (void 0 === h && (h = true), h) {
                        ...
                        if (f >= 0) {
                            ...
                            $.each(e.p.colModel, function () {
                                this.editable === true && e.p.savedRow[f].hasOwnProperty(this.name) && (g[this.name] = e.p.savedRow[f][this.name])
            ...
            return a = $.extend(true, {
                ...
                if (this.grid) {
                    ...
                    if (void 0 === c && (c = true), c)
                        if (a.rowID = $.isFunction(a.rowID) ? a.rowID.call(b, a) : null != a.rowID ? a.rowID : $.jgrid.randId(), a.useDefValues === true && $(b.p.colModel).each(function () {
            ...
            return b = $.extend(true, {
                ...
                if (this.grid && !this.p.inlineNav) {
                    var e = $.jgrid.jqID(c.p.id),
                        f = $.trim($(c).jqGrid("getStyleUI", c.p.styleUI + ".common", "disabled", true));
                    if (c.p.navGrid || $(c).jqGrid("navGrid", a, {
                        ...
                        search: false,
                        view: false
                    }), $(c).data("inlineNav") || $(c).data("inlineNav", b), c.p.force_regional && (b = $.extend(b, d)), c.p.inlineNav = true, b.addParams.useFormatter === true) {
                    ...
                    }), $("#" + e + "_ilcancel").addClass(f)), b.restoreAfterSelect === true && $(c).bind("jqGridBeforeSelectRow.inlineNav", function (a, d) {
                        c.p.savedRow.length > 0 && c.p.inlineNav === true && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : $(c).jqGrid("restoreRow", c.p.selrow, b.editParams), $(c).jqGrid("showAddEditButtons"))
                    })
                }
            })
            ...
            return this.each(function () {
                if (this.grid) {
                    var a = $.jgrid.jqID(this.p.id),
                        b = $.trim($(this).jqGrid("getStyleUI", this.p.styleUI + ".common", "disabled", true));
    ...
    }), $.jgrid._multiselect = false, $.ui && $.ui.multiselect) {
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            return this.each(function () {
                ...
                var c = this,
                    ...
                    e = {
                        ...
                        update: function (a, b) {
                            ...
                            }), $(c).jqGrid("remapColumns", i, true, true), $.isFunction(c.p.sortable.update) && c.p.sortable.update(i), setTimeout(function () {
                ...
                null != h && (h.data("sortable").floating = true)
            })
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(k[0].p.id)).length) {
                if (d = $('<div id="colchooser_' + k[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), e = $("select", d), a = $.extend({
                    ...
                    classname: null,
                        ...
                        a && k.jqGrid("remapColumns", a, true)
                    }, msel: "multiselect",
                    dlog: "dialog",
                    dialog_opts: {
                        minWidth: 470,
            ...
            return this.each(function () {
                ...
                b.grid && (b.p.treeGrid || $.fn.sortable && (a = $.extend({
                    ...
                    axis: "y",
                    items: " > .jqgrow"
                }, a || {}), a.start && $.isFunction(a.start) ? (a._start_ = a.start, delete a.start) : a._start_ = false, a.update && $.isFunction(a.update) ? (a._update_ = a.update, delete a.update) : a._update_ = false, a.start = function (c, d) {
                    ...
                    $(d.item).css("border-width", ""), b.p.rownumbers === true && $("td.jqgrid-rownum", b.rows).each(function (a) {
            ...
            return this.each(function () {
                ...
                if (e.grid && !e.p.treeGrid && $.fn.draggable && $.fn.droppable) {
                    ...
                    if (void 0 === $("#jqgrid_dnd")[0] && $("body").append(f), "string" == typeof a && "updateDnD" === a && e.p.jqgdnd === true) return void b();
                    if (a = $.extend({
                        drag: function (a) {
                            return $.extend({
                                start: function (b, c) {
                            ...
                            return $.extend({
                                accept: function (a) {
                                    ...
                                    if (b.length > 0 && void 0 !== $.data(b[0], "dnd")) {
                                        ...
                                        return -1 !== $.inArray("#" + $.jgrid.jqID(this.id), c) ? true : false
                                    }
                                    return false
                                }, drop: function (b, c) {
                                    if ($(c.draggable).hasClass("jqgrow")) {
                                        ...
                                        if (c.helper.dropped = true, a.beforedrop && $.isFunction(a.beforedrop)) {
                        ...
                        for (a.connectWith = a.connectWith.split(","), a.connectWith = $.map(a.connectWith, function (a) {
                            return $.trim(a)
                        }), $.data(e, "dnd", a), 0 === e.p.reccount || e.p.jqgdnd || b(), e.p.jqgdnd = true, c = 0; c < a.connectWith.length; c++) d = a.connectWith[c], $(d).droppable($.isFunction(a.drop) ? a.drop.call($(e), a) : a.drop)
                }
            })
            ...
            return this.each(function () {
                ...
                if ($t.grid && $.fn.resizable) {
                    if (opts = $.extend({}, opts || {}), opts.alsoResize ? (opts._alsoResize_ = opts.alsoResize, delete opts.alsoResize) : opts._alsoResize_ = false, opts.stop && $.isFunction(opts.stop) ? (opts._stop_ = opts.stop, delete opts.stop) : opts._stop_ = false, opts.stop = function (a, b) {
        ...
        pivotSetup: function (a, b) {
            ...
            return this.each(function () {
                ...
                }, null == j.xDimension[q].isGroupField && (j.xDimension[q].isGroupField = true), z = $.extend(true, z, j.xDimension[q]), c.push(z);
                for (var A = r - 1, B = {}; w > x;) {
                    o = a[x];
                    var C = [],
                        D = [];
                ...
                else h.grouping = false;
                h.sortname = c[A].name, h.groupingView.hideFirstGroupCol = true
            }), {
                colModel: c,
                rows: d,
                groupOptions: h,
            ...
            return this.each(function () {
                function e(a) {
                    var d, e = jQuery(f).jqGrid("pivotSetup", a, b),
                        g = $.assocArraySize(e.summary) > 0 ? true : false,
        ...
        setSubGrid: function () {
                ...
                if (c.grid) {
                    var d, e, f, g, h, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base,
                        ...
                        l = function (a, b) {
                            ...
                            $(g).append(h), a && (f = c.p.xmlReader.subgrid, $(f.root + " " + f.row, a).each(function () {
                                if (h = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), f.repeatitems === true) $(f.cell, this).each(function (a) {
                                    k(h, $(this).text() || "&#160;", a)
                                });
                                else {
                            ...
                            return $("#" + $.jgrid.jqID(l + b)).append(g), c.grid.hDiv.loading = false, $("#load_" + $.jgrid.jqID(c.p.id)).hide(), false
                        },
                        m = function (a, b) {
                            ...
                            if ($(m).append(n), a && (h = c.p.jsonReader.subgrid, e = $.jgrid.getAccessor(a, h.root), void 0 !== e))
                                for (f = 0; f < e.length; f++) {
                                    if (g = e[f], n = $("<tr class='" + j.content + " ui-subtblcell'></tr>"), h.repeatitems === true)
                            ...
                            return $("#" + $.jgrid.jqID(p + b)).append(m), c.grid.hDiv.loading = false, $("#load_" + $.jgrid.jqID(c.p.id)).hide(), false
                        },
                        n = function (a) {
                            var b, d, e, f;
                            if (b = $(a).attr("id"), d = {
                                nd_: (new Date).getTime()
                            }, d[c.p.prmNames.subgridid] = b, !c.p.subGridModel[0]) return false;
                            ...
                            if (!c.grid.hDiv.loading) switch (c.grid.hDiv.loading = true, $("#load_" + $.jgrid.jqID(c.p.id)).show(), c.p.subgridtype || (c.p.subgridtype = c.p.datatype), $.isFunction(c.p.subgridtype) ? c.p.subgridtype.call(c, d) : c.p.subgridtype = c.p.subgridtype.toLowerCase(), c.p.subgridtype) {
                            case "xml":
                            case "json":
                                $.ajax($.extend({
                                    type: c.p.mtype,
                        ...
                        o = 0;
                    $.each(c.p.colModel, function () {
                        (this.hidden === true || "rn" === this.name || "cb" === this.name) && o++
                    });
                    var p = c.rows.length,
                        q = 1;
                    for (void 0 !== b && b > 0 && (q = b, p = b + 1); p > q;) $(c.rows[q]).hasClass("jqgrow") && (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"), $(c.rows[q].cells[a]).bind("click", function () {
                        ...
                        if (e = c.p.id, d = b.id, h = $("#" + e + "_" + d + "_expandedContent"), $(this).hasClass("sgcollapsed")) {
                            if (g = $(c).triggerHandler("jqGridSubGridBeforeExpand", [e + "_" + d, d]), g = g === false || "stop" === g ? false : true, g && $.isFunction(c.p.subGridBeforeExpand) && (g = c.p.subGridBeforeExpand.call(c, e + "_" + d, d)), g === false) return false;
                            c.p.subGridOptions.reloadOnExpand === true || c.p.subGridOptions.reloadOnExpand === false && !h.hasClass("ui-subgrid") ? (f = a >= 1 ? "<td colspan='" + a + "'>&#160;</td>" : "", $(b).after("<tr role='row' id='" + e + "_" + d + "_expandedContent' class='ui-subgrid ui-sg-expanded'>" + f + "<td class='" + j.content + " subgrid-cell'><span class='" + j.icon_base + " " + c.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(c.p.colNames.length - 1 - o, 10) + "' class='" + j.content + " subgrid-data'><div id=" + e + "_" + d + " class='tablediv'></div></td></tr>"), $(c).triggerHandler("jqGridSubGridRowExpanded", [e + "_" + d, d]), $.isFunction(c.p.subGridRowExpanded) ? c.p.subGridRowExpanded.call(c, e + "_" + d, d) : n(b)) : h.show().removeClass("ui-sg-collapsed").addClass("ui-sg-expanded"), $(this).html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + j.icon_base + " " + c.p.subGridOptions.minusicon + "'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded"), c.p.subGridOptions.selectOnExpand && $(c).jqGrid("setSelection", d)
                        } else if ($(this).hasClass("sgexpanded")) {
                            if (g = $(c).triggerHandler("jqGridSubGridRowColapsed", [e + "_" + d, d]), g = g === false || "stop" === g ? false : true, g && $.isFunction(c.p.subGridRowColapsed) && (g = c.p.subGridRowColapsed.call(c, e + "_" + d, d)), g === false) return false;
                            c.p.subGridOptions.reloadOnExpand === true ? h.remove(".ui-subgrid") : h.hasClass("ui-subgrid") && h.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"), $(this).html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + j.icon_base + " " + c.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"), c.p.subGridOptions.selectOnCollapse && $(c).jqGrid("setSelection", d)
                        }
                        return false
                    })), q++;
                    c.p.subGridOptions.expandOnLoad === true && $(c.rows).filter(".jqgrow").each(function (a, b) {
                        $(b.cells[0]).click()
            ...
            return this.each(function () {
                var b = this;
                if ((b.grid || a) && b.p.subGrid === true) {
                    var c = $(this).jqGrid("getInd", a, true);
                    if (c) {
        ...
        setTreeNode: function (a, b) {
                ...
                if (c.grid && c.p.treeGrid)
                    for (var d, e, f, g, h, i, j, k, l = c.p.expColInd, m = c.p.treeReader.expanded_field, n = c.p.treeReader.leaf_field, o = c.p.treeReader.level_field, p = c.p.treeReader.icon_field, q = c.p.treeReader.loaded, r = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common; b > a;) {
                        var s, t = $.jgrid.stripPref(c.p.idPrefix, c.rows[a].id),
                            u = c.p._index[t];
                        j = c.p.data[u], "nested" === c.p.treeGridModel && (j[n] || (d = parseInt(j[c.p.treeReader.left_field], 10), e = parseInt(j[c.p.treeReader.right_field], 10), j[n] = e === d + 1 ? "true" : "false", c.rows[a].cells[c.p._treeleafpos].innerHTML = j[n])), f = parseInt(j[o], 10), 0 === c.p.tree_root_level ? (g = f + 1, h = f) : (g = f, h = f - 1), i = "<div class='tree-wrap tree-wrap-" + c.p.direction + "' style='width:" + 18 * g + "px;'>", i += "<div style='" + ("rtl" === c.p.direction ? "right:" : "left:") + 18 * h + "px;' class='" + r.icon_base + " ", void 0 !== j[q] && (j[q] = "true" === j[q] || j[q] === true ? true : false), "true" === j[n] || j[n] === true ? (i += (void 0 !== j[p] && "" !== j[p] ? j[p] : c.p.treeIcons.leaf) + " tree-leaf treeclick", j[n] = true, k = "leaf") : (j[n] = false, k = ""), j[m] = ("true" === j[m] || j[m] === true ? true : false) && (j[q] || void 0 === j[q]), i += j[m] === false ? j[n] === true ? "'" : c.p.treeIcons.plus + " tree-plus treeclick'" : j[n] === true ? "'" : c.p.treeIcons.minus + " tree-minus treeclick'", i += "></div></div>", $(c.rows[a].cells[l]).wrapInner("<span class='cell-wrapper" + k + "'></span>").prepend(i), f !== parseInt(c.p.tree_root_level, 10) && (s = $(c).jqGrid("isVisibleNode", j), s || $(c.rows[a]).css("display", "none")), $(c.rows[a].cells[l]).find("div.treeclick").bind("click", function (a) {
                            var b = a.target || a.srcElement,
                                d = $.jgrid.stripPref(c.p.idPrefix, $(b, c.rows).closest("tr.jqgrow")[0].id),
                                e = c.p._index[d];
                            return c.p.data[e][n] || (c.p.data[e][m] ? ($(c).jqGrid("collapseRow", c.p.data[e]), $(c).jqGrid("collapseNode", c.p.data[e])) : ($(c).jqGrid("expandRow", c.p.data[e]), $(c).jqGrid("expandNode", c.p.data[e]))), false
                        }), c.p.ExpandColClick === true && $(c.rows[a].cells[l]).find("span.cell-wrapper").css("cursor", "pointer").bind("click", function (a) {
                            var b = a.target || a.srcElement,
                                d = $.jgrid.stripPref(c.p.idPrefix, $(b, c.rows).closest("tr.jqgrow")[0].id),
                                e = c.p._index[d];
                            return c.p.data[e][n] || (c.p.data[e][m] ? ($(c).jqGrid("collapseRow", c.p.data[e]), $(c).jqGrid("collapseNode", c.p.data[e])) : ($(c).jqGrid("expandRow", c.p.data[e]), $(c).jqGrid("expandNode", c.p.data[e]))), $(c).jqGrid("setSelection", d), false
                        }), a++
                    }
            })
            ...
            return this.each(function () {
                ...
                if (e.p.treeGrid) {
                    ...
                    }), e.p.loadonce && (e.p.treedatatype = "local"), e.p.subGrid = false, e.p.altRows = false, e.p.pgbuttons = false, e.p.pginput = false, e.p.gridview = true, null === e.p.rowTotal && (e.p.rowNum = 1e4), e.p.multiselect = false, e.p.rowList = [], e.p.expColInd = 0, a = i.icon_plus, "jQueryUI" === e.p.styleUI && (a += "rtl" === e.p.direction ? "w" : "e"), e.p.treeIcons = $.extend({
                        plus: a,
                        minus: i.icon_minus,
                        leaf: i.icon_leaf
                    ...
                    for (c in e.p.colModel)
                        if (e.p.colModel.hasOwnProperty(c)) {
                            b = e.p.colModel[c].name, b !== e.p.ExpandColumn || g || (g = true, e.p.expColInd = f), f++;
            ...
            this.each(function () {
                ...
                if (b.grid && b.p.treeGrid) {
                    var c = $(b).jqGrid("getNodeChildren", a),
                        ...
                        f = $.isFunction(b.p.beforeExpandTreeGridRow) ? b.p.beforeExpandTreeGridRow.call(b, e, a, c) : true;
                    f !== false && ($(c).each(function () {
            ...
            this.each(function () {
                ...
                if (b.grid && b.p.treeGrid) {
                    var c = $(b).jqGrid("getNodeChildren", a),
                        d = b.p.treeReader.expanded_field,
                        e = a[b.p.localReader.id],
                        f = $.isFunction(b.p.beforeCollapseTreeGridRow) ? b.p.beforeCollapseTreeGridRow.call(b, e, a, c) : true;
                    f !== false && ($(c).each(function () {
                        var a = b.p.idPrefix + $.jgrid.getAccessor(this, b.p.localReader.id);
            ...
            return this.each(function () {
                var c, d, e, f = this;
                if (f.grid && f.p.treeGrid) switch ("boolean" != typeof a && (a = false), e = a ? $(f).jqGrid("getRowData", null, true) : f.p.data, f.p.treeGridModel) {
                case "nested":
            ...
            return this.each(function () {
                ...
                case "nested":
                    ...
                    $(this.p.data).each(function () {
                        return parseInt(this[f], 10) === i - 1 && parseInt(this[d], 10) < g && parseInt(this[e], 10) > h ? (b = this, false) : void 0
                    });
                    break;
                case "adjacency":
            ...
            return this.each(function () {
                ...
                if (e.grid && e.p.treeGrid) switch ((null == b || "boolean" != typeof b) && (b = false), e.p.treeGridModel) {
                case "nested":
                    var g = e.p.treeReader.left_field,
                        ...
                        l = parseInt(a[i], 10);
                    $(this.p.data).each(function () {
                        parseInt(this[i], 10) >= l && parseInt(this[g], 10) >= j && parseInt(this[g], 10) <= k && (b && (this[f] = true), c.push(this))
                    });
                    break;
                case "adjacency":
                    if (a) {
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    $(d).each(function () {
                        return b = b && this[e], b ? void 0 : false
                    })
                }
            }), b
            ...
            return this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    b = void 0 !== a ? void 0 !== a[e] ? a[e] : a[d] || $(c).jqGrid("getNodeChildren", a).length > 0 ? true : false : false
                }
            }), b
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    a[d] = true, $("div.treeclick", k).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = k.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? $(this).jqGrid("setGridParam", {
                        postData: {
                            nodeid: j,
                            n_left: a[h],
                            n_right: a[i],
                    ...
                    }), $(this).trigger("reloadGrid"), a[f] = true, "nested" === this.p.treeGridModel ? $(this).jqGrid("setGridParam", {
                        selrow: c,
                        postData: {
                            nodeid: "",
                            n_left: "",
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!a[b]) {
                        var h = $.jgrid.getAccessor(a, this.p.localReader.id),
                            ...
                            j = this.p._index[h],
                            k = $.isFunction(this.p.beforeExpandTreeGridNode) ? this.p.beforeExpandTreeGridNode.call(this, h, a) : true;
                        if (k === false) return;
                        $(this).jqGrid("isNodeLoaded", this.p.data[j]) ? (a[b] = true, $("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (a[b] = true, $("div.treeclick", i).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = i.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel ? $(this).jqGrid("setGridParam", {
                            postData: {
                                nodeid: h,
                                n_left: a[f],
                                n_right: a[g],
                        ...
                        }), $(this).trigger("reloadGrid"), a[d] = true, "nested" === this.p.treeGridModel ? $(this).jqGrid("setGridParam", {
                            postData: {
                                nodeid: "",
                                n_left: "",
                                n_right: "",
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (a[b]) {
                        var c = $.jgrid.getAccessor(a, this.p.localReader.id),
                            d = $.isFunction(this.p.beforeCollapseTreeGridNode) ? this.p.beforeCollapseTreeGridNode.call(this, c, a) : true,
                            e = $("#" + this.p.idPrefix + $.jgrid.jqID(c), this.grid.bDiv)[0];
                        if (a[b] = false, d === false) return;
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid && e)
                    for (c = this.p.localReader.id, b = 0; e > b; b++) f = $(this).jqGrid("getNodeAncestors", a[b]), f.length || f.push(a[b]), d = f[f.length - 1][c], -1 === $.inArray(d, g) && (g.push(d), f = $(this).jqGrid("getFullTreeNode", f[f.length - 1], true), h = h.concat(f))
            }), h
            ...
            if (c) {
                var f, g, h, i, j, k, l, m, n = e.p.treeReader.expanded_field,
                    ...
                    u = 0,
                    v = b;
                if (void 0 === d && (d = false), null == a) {
                    if (j = e.p.data.length - 1, j >= 0)
                        for (; j >= 0;) u = Math.max(u, parseInt(e.p.data[j][e.p.localReader.id], 10)), j--;
                    a = u + 1
                }
                var w = $(e).jqGrid("getInd", b);
                if (l = false, void 0 === b || null === b || "" === b) b = null, v = null, f = "last", i = e.p.tree_root_level, j = e.p.data.length + 1;
                else {
                    f = "after", g = e.p._index[b], h = e.p.data[g], b = h[e.p.localReader.id], i = parseInt(h[p], 10) + 1;
                    var x = $(e).jqGrid("getFullTreeNode", h);
                    x.length ? (j = x[x.length - 1][e.p.localReader.id], v = j, j = $(e).jqGrid("getInd", v) + 1) : j = $(e).jqGrid("getInd", b) + 1, h[o] && (l = true, h[n] = true, $(e.rows[w]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(e.p.treeIcons.leaf + " tree-leaf").addClass(e.p.treeIcons.minus + " tree-minus"), e.p.data[g][o] = false, h[t] = true)
                } if (k = j + 1, void 0 === c[n] && (c[n] = false), void 0 === c[t] && (c[t] = false), c[p] = i, void 0 === c[o] && (c[o] = true), "adjacency" === e.p.treeGridModel && (c[q] = b), "nested" === e.p.treeGridModel) {
                    var y, z, A;
                    if (null !== b) {
                        ...
                        if (m = parseInt($(e).jqGrid("getCol", s, false, "max"), 10), z = $.jgrid.from.call(e, e.p.data).greater(r, m, {
                            stype: "integer"
                        }).select(), z.length)
        ...
        E1, M1, i = function (a, b, c, d) {
            return a.each(function () {
                b = b ? $(b, a) : a, b.bind("mousedown", {
                    ...
                    var b = a.data,
                        c = {};
                    if (E = b.e, E1 = d ? $(d) : false, "relative" != E.css("position")) try {
                        E.position(c)
                    } catch (e) {}
                    if (M = {
                        X: c.left || f("left") || 0,
                        ...
                        pY: a.pageY,
                        k: b.k
                    } : false, $("input.hasDatepicker", E[0])[0]) try {
                        $("input.hasDatepicker", E[0]).datepicker("hide")
                    } catch (g) {}
                    return $(document).mousemove($.jqDnR.drag).mouseup($.jqDnR.stop), false
                })
            })
        },
        f = function (a) {
            return parseInt(E.css(a), 10) || false
        },
        f1 = function (a) {
            return parseInt(E1.css(a), 10) || false
        };
    $.fn.jqm = function (a) {
        var b = {
            overlay: 50,
        ...
        open: function (a, b) {
            ...
            if (c.a) return F;
            if (c.t = b, c.a = true, c.w.css("z-index", g), d.modal ? (A[0] || setTimeout(function () {
                new L("bind")
    ...
    var s = 0,
        ...
        m = function (a) {
            ...
            return c && ($(".jqmID" + b.s).each(function () {
                var b = $(this),
                    d = b.offset();
                return d.top <= a.pageY && a.pageY <= d.top + b.height() && d.left <= a.pageX && a.pageX <= d.left + b.width() ? (c = false, false) : void 0
            }), f(b)), !c
        },
        hs = function (a, b, c) {
            return a.each(function () {
    ...
    $.fmatter = {}, $.extend($.fmatter, {
        isBoolean: function (a) {
            ...
            return a && ("object" == typeof a || $.isFunction(a)) || false
        }, isString: function (a) {
            ...
            return !this.isString(a) && this.isValue(a) ? false : this.isValue(a) ? (a = $.trim(a).replace(/\&nbsp\;/gi, "").replace(/\&#160\;/gi, ""), "" === a) : true
        }
        ...
        void 0 !== b.colModel && void 0 !== b.colModel.formatoptions && (d = $.extend({}, d, b.colModel.formatoptions)), c = d.disabled === true ? 'disabled="disabled"' : "", ($.fmatter.isEmpty(a) || void 0 === a) && (a = $.fn.fmatter.defaultFormat(a, d)), a = String(a), a = (a + "").toLowerCase();
        ...
        if (void 0 !== b.colModel.formatoptions ? (e = b.colModel.formatoptions.value, c = void 0 === b.colModel.formatoptions.separator ? ":" : b.colModel.formatoptions.separator, d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter) : void 0 !== b.colModel.editoptions && (e = b.colModel.editoptions.value, c = void 0 === b.colModel.editoptions.separator ? ":" : b.colModel.editoptions.separator, d = void 0 === b.colModel.editoptions.delimiter ? ";" : b.colModel.editoptions.delimiter), e) {
            var g, h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === true) == true ? true : false,
                i = [];
        ...
        return void 0 !== e ? e : d === true ? $(a).text() : $.jgrid.htmlDecode($(a).html())
                    ...
                    parseElement = function (a) {
                        if (7 !== a.nodeType) {
                            ...
                            if (a.childNodes && a.childNodes.length) {
                                var h = true;
                                for (c && (h = false), d = 0; d < a.childNodes.length && h; d++) {
...
var JucheapGrid = {
    Load: function (n) {
        ...
        var n = $("#jqGridList").jqGrid("getGridParam", "selrow");
        return n ? $("#jqGridList").jqGrid("getRowData", n) : null;
    }, GetDataTableDeleteData: function () {
        return JucheapGrid.GetAllSelected("jqGridList");
        ...
        var t = {
            ...
            f = u.jqGrid("getGridParam", "selrow"),
            r, i;
        if (f) {
            //for (r = u.getGridParam("selarrrow"), i = 0; i < r.length; i++) t.Data.push(r[i]);
            var array = u.jqGrid("getGridParam", "selarrrow");
            for (r = array, i = 0; i < r.length; i++)
                t.Data.push(r[i]);
        }
...
var XPage = {
    DelData: function (n) {
        ...
        t.Len > 0 && t.Data.length > 0 ? layer.confirm("确认要删除这" + t.Len + "条数据？", {
                btn: ["确认", "取消"]
            },
            function () {
                var i = $("#btnDel");
            ...
            function () {}) : layer.alert("请选择要删除的数据！");
    }, GoTo: function (n, t) {
        $(n).button("loading");
        window.location.href = t;
    }, Search: function (n) {
        var t = $("#jqGridList").jqGrid("getGridParam", "postData");
        $.extend(t, n);
        ...
        e = $.ajax({
            ...
            success: function (t) {
                ...
                complete: function (t, i) {
                    f && $(n).button("reset");
                    i === "timeout" && (e.abort(), layer.alert("请求超时，请刷新页面重试"));
                    i === "error" && (e.abort(), layer.alert("请求失败，请刷新页面重试"));
                }
        });
